    ...
    public class PortalController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(Portal portal)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_PortalAuthorise" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> GetIni(Ini ini)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_PortalIni" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> GetLog(Ini ini)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_PortalGetLog" ,CommandType.StoredProcedure
                         ,"@branch" ,SqlDbType.NVarChar ,ini.branch);
                }
                if (ds != null)
                {
        ...
        public async Task<IActionResult> GetExam(Ini ini)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_PortalGetExam" ,CommandType.StoredProcedure);
                }
                if (ds != null)
                {
                    return Content(Comon.DataJson.Dataset(ds));
        ...
        public async Task<IActionResult> GetPrehistory(Ini ini)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_PortalGetPrehistory" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> ProfileInsert(PortalProfile pro)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_PortalProfileInsert" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> RatingGetType(Ratingtype rattype)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    if (rattype.type != 0)
                    {
                        ds = await confunc.ExecuteDataSet("YYY_sp_PortalRating_LoadType" ,CommandType.StoredProcedure ,
