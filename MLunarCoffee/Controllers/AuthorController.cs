    ...
    public class AuthorController : ControllerBase
    {
        ...
        public async Task<IActionResult> ChangeLan(UserLan userLan)
        {
            try
            {
                ...
                {
                    await confunc.ExecuteDataTable("YYY_sp_LangUserUpdate" ,CommandType.StoredProcedure
        ...
        private static async Task<string> CheckIP(string userid ,string encryip)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Detect_IP]" ,CommandType.StoredProcedure ,
                        "@userID" ,SqlDbType.Int ,userid ,
            ...
            try
            {
                ...
                else
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        await confunc.ExecuteDataTable("YYY_sp_InsertLogClear" ,CommandType.StoredProcedure
