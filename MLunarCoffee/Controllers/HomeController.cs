    ...
    public class HomeController : ControllerBase
    {
        ...
        public async Task<IActionResult> SessionData()
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_Session_Load", CommandType.StoredProcedure);
                }
                //RebuildLocalization();
        ...
        public async Task<IActionResult> UpdateGroupUser(UserGroup userGroup)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_User_UpdateGroup", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> TokenUser(UserToken user)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_TokenUser", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> TokenMultiUser(UsersToken user)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_TokenMultiUser", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> MobileCust(MobileCust cust)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_TokenMobile_Customer", CommandType.StoredProcedure
