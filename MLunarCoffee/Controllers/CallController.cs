    ...
    public class CallController : ControllerBase
    {
        ...
        public async Task<IActionResult> InCommingCall(InComming inComming)
        {
            try
            {
                if (inComming.phone != "")
                {
                    ...
                    {
                        dt = await confunc.ExecuteDataTable("YYY_sp_Calling_GetInCommingCall", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OutCommingCall(OutComming outComming)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_Calling_GetOutCommingCall",
        ...
        public async Task<IActionResult> DetectPhone(OutComming outComming)
        {
            try
            {
                ...
                if (outComming.cus != "")
                {
                    ...
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        dt = await confunc.ExecuteDataTable("YYY_sp_CallOutSide_GetPhone", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> StoreLogs(LogCall logCall)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_LogCall_Insert]", CommandType.StoredProcedure
