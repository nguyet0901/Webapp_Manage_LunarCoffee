    ...
    public class AfterStatusController : ControllerBase
    {
        ...
        public async Task<IActionResult> bookingSchedule(AfterStatusPara afterStatus)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_Schedule_Next_Customer" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> evaluate(AfterStatusPara afterStatus)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_PortalRating_LoadType" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> evaluateInPortal(AfterStatusPara afterStatus)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_Portal_GetProfileInDay" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> treatinday(AfterStatusPara afterStatus)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_Customer_LoadInfo_TreatmentInDay" ,CommandType.StoredProcedure
