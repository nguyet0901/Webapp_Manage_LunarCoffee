    ...
    public static class SMSAction
    {
        ...
        public static async Task<string> SMS_Pending(string customerid ,string userid ,string phone ,string amount ,string content ,string branchid)
        {
            try
            {
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_SMS_Insert]" ,CommandType.StoredProcedure ,
        ...
        public static async Task<SMSContentTemplate> GetTemplate(SMSTemplate sms)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_SMS_Option_LoadTemplate]" ,CommandType.StoredProcedure ,
            ...
            try
            {
                ...
                switch (sms.template_type.ToLower())
                {
                    case "smscontentafterpayment":
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("MLU_sp_SMS_AfterPayment" ,CommandType.StoredProcedure ,
                    ...
                    case "smscontentafterappointment":
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_SMS_AfterSchedule]" ,CommandType.StoredProcedure ,
                                "@CustID" ,SqlDbType.Int ,sms.cust_id ,
                    ...
                    case "nextschedule":
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("MLU_sp_Auto_AfterStatus_NextScheduleTemp" ,CommandType.StoredProcedure
                                ,"@CustID" ,SqlDbType.Int ,sms.cust_id);
                        }
                        break;
                    case "evaluating":
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("MLU_sp_Auto_AfterStatus_LoadEvaluatingTemp" ,CommandType.StoredProcedure
                                ,"@CustID" ,SqlDbType.Int ,sms.cust_id);
                        }
                        break;
                    case "treatinday":
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("MLU_sp_Auto_AfterStatus_LoadTreatInDayTemp" ,CommandType.StoredProcedure
                                ,"@CustID" ,SqlDbType.Int ,sms.cust_id);
                        }
                        break;
                    default:
                        using (ExecuteDataBase connFunc = new ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_SMS_LoadKeySend]" ,CommandType.StoredProcedure ,
                                "@CustID" ,SqlDbType.Int ,sms.cust_id ,
