...
namespace MLunarCoffee.Comon.AfterPayment
{
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        if (dt != null && dt.Rows.Count != 0)
                        {
                            ...
                            if (dataSend != "")
                            {
                                ...
                                {
                                    dataResult.Result = await MLunarCoffee.Comon.SMS.SMSAction.SMS_Pending(CustomerID ,userid ,dataResult.Phone ,amount ,dataSend ,branchid);
                                }
                            }
                        }
                    }
