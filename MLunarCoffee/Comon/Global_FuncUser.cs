...
namespace MLunarCoffee.Comon
{
    public class Global_FuncUser
    {
        ...
        public async Task<DataSet> UserInfo(int usserid)
        {
            ...
            {
                ds = await confunc.ExecuteDataSet("[MLU_sp_GetGlobal_User]"
        ...
        public async Task<DataTable> UserCall(int usserid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_GetGlobal_CallExtension]"
                    , CommandType.StoredProcedure, "@UserID", SqlDbType.Int, usserid);
            }
            return dt;
        }
        ...
        public async Task<DataTable> Webhook()
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Option_GetWebhook]", CommandType.StoredProcedure);
            }
            return dt;
        }
        ...
        public async Task<DataTable> UserMenu(int roleid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Permission_LoadMenuGroup]", CommandType.StoredProcedure,
        ...
        public async Task<DataTable> UserTabControl(int roleid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Per_GeExtentControlTab]", CommandType.StoredProcedure,
                    "@GroupID", SqlDbType.Int, Convert.ToInt32(roleid));
            }
            return dt;
        }
        ...
        public async Task<DataTable> UserDashboard(int roleid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_GetHas_Dashboard]", CommandType.StoredProcedure
        ...
        public async Task<DataTable> Email()
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Option_Mail_Get]", CommandType.StoredProcedure);
            }
            return dt;
        }
        ...
        public async Task<DataTable> UserPerEditRole(int usserid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_GetPermissionEditRole]", CommandType.StoredProcedure, "@UserID"
        ...
        public async Task UserLock(int id)
        {
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                await confunc.ExecuteDataTable("[MLU_sp_LockUserExpire]", CommandType.StoredProcedure, "@UserID", SqlDbType.Int, id);
            }
        }
        ...
        private async Task<DataTable> User_GetMenuFromDB(string GroupID)
        {
            try
            {
                ...
                {
                    dtExt = await connFunc.ExecuteDataTable("MLU_sp_Per_GeExtentMenu", CommandType.StoredProcedure,
        ...
        public async Task<DataTable> GetOptionExtension()
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Option_GetExtension]", CommandType.StoredProcedure);
            }
            return dt;
        }
