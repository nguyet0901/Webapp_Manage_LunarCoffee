        ...
        public async Task<IActionResult> OnPostInitialization(int Type)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerCare_LoadStatus_ByType]", CommandType.StoredProcedure,
            ...
            try
            {
                ...
                switch (Type)
                {
                    case 1:
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerCare_ToRemind_Appointment]" , CommandType.StoredProcedure
                    ...
                    case 3:
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerCare_ToTakeCare_Holiday]" ,CommandType.StoredProcedure
                             ,"@BranchID" ,SqlDbType.Int ,dtMain.BranchID
                             ,"@BranchToken" ,SqlDbType.NVarChar ,dtMain.BranchToken
                             ,"@StaffID" ,SqlDbType.Int ,dtMain.StaffID
                             ,"@datefrom" ,SqlDbType.DateTime ,Comon.Comon.DateTimeDMY_To_YMD(DateFrom)
                    ...
                    case 4:
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerCare_ToFollow_NotCheckIn]", CommandType.StoredProcedure
                             , "@BranchID", SqlDbType.Int, dtMain.BranchID
                             , "@BranchToken", SqlDbType.NVarChar, dtMain.BranchToken
                             , "@StaffID", SqlDbType.Int, dtMain.StaffID
                             , "@datefrom", SqlDbType.DateTime, Comon.Comon.DateTimeDMY_To_YMD(DateFrom)
                    ...
                    case 10:
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerCare_ToTakeCare_AppointmentCancel]", CommandType.StoredProcedure
                             , "@BranchID", SqlDbType.Int, dtMain.BranchID
                             , "@BranchToken", SqlDbType.NVarChar, dtMain.BranchToken
                             , "@StaffID", SqlDbType.Int, dtMain.StaffID
                             , "@datefrom", SqlDbType.DateTime, Comon.Comon.DateTimeDMY_To_YMD(DateFrom)
