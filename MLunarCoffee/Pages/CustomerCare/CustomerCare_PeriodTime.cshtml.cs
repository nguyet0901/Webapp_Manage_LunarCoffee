    ...
    public class CustomerCare_PeriodTimeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitialization()
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtServiceType = new DataTable();
                        dtServiceType = await confunc.ExecuteDataTable("[YYY_sp_ListTele]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtServiceType = new DataTable();
                        dtServiceType = await confunc.ExecuteDataTable("[YYY_sp_CustomerCare_LoadStatus_ByType]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadData(string data, string DateFrom, string DateTo, string TreatID, string BeginID, string Limit)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_CustomerCare_ToTakeCare_PeriodicTime]", CommandType.StoredProcedure
