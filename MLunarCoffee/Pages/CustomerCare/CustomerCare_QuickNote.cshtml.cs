    ...
    public class CustomerCare_QuickNoteModel : PageModel
    {
            ...
            try
            {
                ...
                switch (Type_Care)
                {
                    ...
                    case 10:
                        ...
                        {
                            await connFunc.ExecuteDataTable("YYY_sp_CustomerCare_InsertValue", CommandType.StoredProcedure,
                    ...
                    case 6:
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            await connFunc.ExecuteDataTable("YYY_sp_CustomerCare_InsertValue_Complaint", CommandType.StoredProcedure,
                                "@MasterID", SqlDbType.Int, DataMain.MasterID,
                                "@CustomerID", SqlDbType.Int, DataMain.CustomerID,
                                "@AppID", SqlDbType.Int, DataMain.AppID,
                                "@IsDone", SqlDbType.Int, DataMain.IsDone,
         ...
         public async Task<IActionResult> OnPostLoadNoteTeamplate(int Type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt =await connFunc.ExecuteDataTable("YYY_sp_CustomerCare_LoadQuickTeamplate_ByType", CommandType.StoredProcedure,
