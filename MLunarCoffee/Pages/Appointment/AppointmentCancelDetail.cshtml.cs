    ...
    public class AppointmentCancelDetailModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostInitialize()
        {
            try
            {
                ...
                {
                    dt =await  confunc.ExecuteDataTable("MLU_sp_Appointment_LoadReasonCancel", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostExcuteData (string data, string CurrentID)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        dt =await connFunc.ExecuteDataTable("[MLU_sp_Appoinment_Cancel]", CommandType.StoredProcedure,
