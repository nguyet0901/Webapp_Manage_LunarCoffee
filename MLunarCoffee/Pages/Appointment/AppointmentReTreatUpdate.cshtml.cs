    ...
    { 
         ...
         public async Task<IActionResult> OnPostLoadDataDetail(string CustomerID)
        {
            try
            {
                ...
                {
                    dt =await  confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_ReTreat_Load]", CommandType.StoredProcedure
         ...
         public async Task<IActionResult> OnPostExcuteData(string data, string Customer_ID)
        {
            try
            {
                ...
                {
                    DataTable dt1 =await connFunc.ExecuteDataTable("YYY_sp_Customer_App_ReTreat_Update", CommandType.StoredProcedure,
