    ...
    public class AppointmentModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadScheduler(string datefrom, string dateto, int branch, int DoctorID, int AppID, int type, int IsTemp)
        {
            try
            {
                if (AppID == 0)
                {
                    ...
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ds = await confunc.ExecuteDataSet("[YYY_sp_v2_Appointment_Doctor_Schedule_LoadList]", CommandType.StoredProcedure,
                ...
                else
                {
                    ...
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        dt = await confunc.ExecuteDataTable("[YYY_sp_v2_Appointment_Doctor_Schedule_LoadList]", CommandType.StoredProcedure,
                            "@DateFrom", SqlDbType.NVarChar, datefrom
                            , "@DateTo", SqlDbType.NVarChar, dateto
                            , "@DoctorID", SqlDbType.Int, DoctorID
                            , "@AppID", SqlDbType.Int, AppID
        ...
        public async Task<IActionResult> OnPostUpdateScheduler(DateTime datefrom, DateTime dateto, int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    if (id > 0)
                    {
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Doctor_Schedule_Update]", CommandType.StoredProcedure,
                    ...
                    {
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Doctor_Schedule_Temp_Update]", CommandType.StoredProcedure,
                                "@DateFrom", SqlDbType.DateTime, datefrom
                                , "@DateTo", SqlDbType.DateTime, dateto
                                , "@ID", SqlDbType.Int, id
                                , "@UserID", SqlDbType.Int, user.sys_userid);
        ...
        public async Task<IActionResult> OnPostDeleteNote(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Doctor_Schedule_Temp_Delete]", CommandType.StoredProcedure
                       , "@ID", SqlDbType.Int, id
                       , "@UserID", SqlDbType.Int, user.sys_userid);
                }
                if (dt != null)
        ...
        public async Task<IActionResult> OnPostCheckSchedulerIsEdit(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Doctor_Schedule_CheckAppointment]", CommandType.StoredProcedure
                       , "@ID", SqlDbType.Int, id);
                }
                if (dt != null)
                {
        ...
        public async Task<IActionResult> OnPostLoadDataAction(int appointment)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Schedule_Action_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadtemdata(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_Temp_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostSearchCustomer(string search)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_AppointmentTemp_SearchCustomer]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteTemp(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Customer_Appointment_Temp_Insert", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Customer_Appointment_Temp_Update", CommandType.StoredProcedure,
