    ...
    public class AppointmentDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadCombo(string cusid ,string currentid ,string treatID ,string ticketid)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_Appointment_LoadComboTime" ,CommandType.StoredProcedure);
                        dt.TableName = "Time";
                        return dt;
                    }
                }));
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_Appointment_LoadCustomerInfo" ,CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_Schedule_LoadCombo_ServiceTreatment" ,CommandType.StoredProcedure
                              ,"@CustomerID" ,SqlDbType.Int ,cusid);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_LoadExpectedAmount]" ,CommandType.StoredProcedure ,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Schedule_Type_LoadCombo]" ,CommandType.StoredProcedure);
                ...
                if (treatID != "0" && treatID != null)
                {
                    tasks.Add(Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dt = new DataTable();
                            dt = await confunc.ExecuteDataTable("[YYY_sp_Schedule_TreatmentContentNext]" ,CommandType.StoredProcedure ,
                ...
                if (ticketid != "0" && ticketid != null)
                {
                    tasks.Add(Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dt = new DataTable();
                            dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Ticket_LoadHistoryCare]" ,CommandType.StoredProcedure ,
                ...
                if (Convert.ToInt32(currentid) != 0)
                {
                    tasks.Add(Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dt = new DataTable();
                            dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_LoadToDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteDataAppointmentData(string data ,string CurrentID ,string CustomerID ,string TicketID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        ds = await connFunc.ExecuteDataSet("YYY_sp_v2_Customer_Appointment_Insert" ,CommandType.StoredProcedure ,
                ...
                else // Cập nhật lịch hẹn
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ds = await connFunc.ExecuteDataSet("YYY_sp_v2_Customer_Appointment_Update" ,CommandType.StoredProcedure ,
                            "@Customer_ID" ,SqlDbType.Int ,CustomerID ,
                            "@branch_ID" ,SqlDbType.Int ,DataMain.branch_ID ,
                            "@Doctor_ID" ,SqlDbType.Int ,DataMain.Doctor_ID ,
                            "@Assistant" ,SqlDbType.Int ,DataMain.Assistant ,
        ...
        public async Task<IActionResult> OnPostGetInfoAppointment(string CustomerID ,string Date ,string BranchID ,string CurrentAppID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_Appointment_LoadInfo_Branch_And_Customer]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostCheckDataDetail(string CustomerID ,string DateFrom ,string BranchID ,string CurrentAppID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_Check_Data]" ,CommandType.StoredProcedure
                            ,"@Customer_ID" ,SqlDbType.Int ,Convert.ToInt32(CustomerID)
                            ,"@Branch_ID" ,SqlDbType.Int ,Convert.ToInt32(BranchID)
        ...
        public async Task<IActionResult> OnPostLoaData_Extension_Doctor(int BranchID ,int EmpID ,string dateFrom ,string dateTo ,int AppID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Appointment_Doctor_ByDay]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDuplicate(string AppID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Appointment_Duplicate_LoadDetail]" ,CommandType.StoredProcedure ,
