    ...
    { 
         ...
         public async Task<IActionResult> OnPostInitializeData(string CurrentID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_RoomStatus_Choosing_Room]", CommandType.StoredProcedure
         ...
         public async Task<IActionResult> OnPostExcuteData(string RoomID,string Chairid, string CurrentID)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        dt =await connFunc.ExecuteDataTable("[YYY_sp_Appoinment_SetUpRoom]", CommandType.StoredProcedure,
