    ...
    public class StatusOptionModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtCashBackReason = await connFunc.ExecuteDataTable("[YYY_sp_Employee_LoadCombo_Group]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadData(int statusid ,int custID ,int appID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Schedule_StatusOption_LoadInfo]" ,CommandType.StoredProcedure
