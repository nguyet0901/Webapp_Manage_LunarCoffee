    ...
    public class ClassAdjustmentModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string ClassTimeID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_ST_ClassDetail_Info]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_ST_ClassTime_Update", CommandType.StoredProcedure,
