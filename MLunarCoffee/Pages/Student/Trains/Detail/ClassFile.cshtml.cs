    ...
    public class ClassFile : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadFile(string begin, string limit)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ST_ClassFile_Load]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostSearch(string name)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_ST_ClassFile_Search]", CommandType.StoredProcedure,
