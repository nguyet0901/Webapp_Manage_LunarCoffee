    ...
    public class CourseListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string BranchID, string DateFrom, string DateTo, string BeginID, string Limit, string Currentid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_ST_Settings_Course_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadDetail(string Currentid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_ST_Settings_Course_LoadListDetail]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, Currentid);
                }
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_ST_Settings_Course_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDisableItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_ST_Settings_Course_Disabled]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@ModifiedBy", SqlDbType.Int, user.sys_userid
                    );
                }
