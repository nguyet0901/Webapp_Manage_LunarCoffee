    ...
    public class EnrollmentModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboCourse(string DateFrom, string DateTo, string BranchID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ST_Course_LoadCombo]", CommandType.StoredProcedure,
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ST_Discount_LoadCombo]", CommandType.StoredProcedure,
                        "@BranchID", SqlDbType.Int, BranchID);
        ...
        public async Task<IActionResult> OnPostLoadData(string CourseID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ST_Class_LoadByCourse]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcutedData(string obj, string courseID, string totalPrice)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ST_Student_Enrollment]", CommandType.StoredProcedure
