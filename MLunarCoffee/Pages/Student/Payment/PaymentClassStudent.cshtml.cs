    ...
    public class PaymentClassStudentModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInit()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_ST_InfoSms", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadPayment(string StudentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_ST_Student_Payment_Load", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostCheckValidPayment(string dataDetail)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_ST_Student_Payment_CheckValid", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string StudentID, string data, string dataDetail)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_ST_Student_Payment_Insert", CommandType.StoredProcedure
                        , "@StudentID", SqlDbType.Int, StudentID
