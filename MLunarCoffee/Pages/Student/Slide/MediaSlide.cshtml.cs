    ...
    public class MediaSlideModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSlideType = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_TrainSlideType_LoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSlideTag = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_TrainSlideTag_LoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtSlideType = new DataTable();
                        dtSlideType = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_MediaAttachmentType_LoadCombo]", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExecutedSlide(string data, int CurrentID)
        {
            try
            {
                ...
                if (CurrentID == 0)
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_TrainSlide_Insert]", CommandType.StoredProcedure
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_TrainSlide_Update]", CommandType.StoredProcedure
                            , "@SlideTypeID", SqlDbType.Int, Convert.ToInt32(DataMain.SlideTypeID)
                            , "@Code", SqlDbType.NVarChar, DataMain.Code
                            , "@Name", SqlDbType.NVarChar, DataMain.Name
                            , "@TagID", SqlDbType.Int, Convert.ToInt32(DataMain.TagID)
        ...
        public async Task<IActionResult> OnPostInsertFiles(string Name, string URL, string SlideID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_MediaAttachment_Insert]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDeleteFile(int IDMediaAttach,int IDSlideAttach, string URL) {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_MediaAttachment_Delete]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecutedContent(string slideid, string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_ST_Settings_TrainContent_Insert]", CommandType.StoredProcedure
