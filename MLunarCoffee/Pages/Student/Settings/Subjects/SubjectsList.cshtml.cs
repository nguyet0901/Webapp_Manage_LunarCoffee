    ...
    public class SubjectsListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(string CourseID, string SubjectID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_ST_Settings_Subjects_Load]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_ST_Settings_ListCourse_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItemSub(int IDSubject, int IDCourse)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_ST_Settings_ListSubject_Delete]", CommandType.StoredProcedure,
