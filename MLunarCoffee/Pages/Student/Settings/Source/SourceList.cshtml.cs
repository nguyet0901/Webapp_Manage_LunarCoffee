    ...
    public class SourceListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_ST_Settings_Source_LoadList", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostDeleteItem(string CurrentID)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("YYY_sp_ST_Settings_Source_Delete", CommandType.StoredProcedure,
