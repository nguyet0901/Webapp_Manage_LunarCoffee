    ...
    public class CertificateListModel : PageModel
    {
        public async Task<IActionResult> OnPostLoadData(string IdDetail)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_ST_Certificate_Load", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDelete(string IdDetail, string State)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_ST_Certificate_Delete", CommandType.StoredProcedure,
