    ...
    public class ExaminationListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_ST_Settings_Examination_LoadList", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostDeleteItem(string CurrentID)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("YYY_sp_ST_Settings_Examination_Delete", CommandType.StoredProcedure,
