...
namespace SourceMain.Pages.Disease
{
    ...
    public class DentistImage : PageModel {
        ...
        public void OnGet ( ) {
         ...
         public async Task<IActionResult> OnPostLoadata ( int id ) {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                dt =await  confunc.ExecuteDataTable ("[YYY_sp_Dentist_Chart_Teeth_LoadDetail]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostExcuteData ( string TeethName,  string CurrentID ) {
            try {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                    DataTable dt =await connFunc.ExecuteDataTable ("[YYY_sp_Dentist_Chart_Teeth_Update]", CommandType.StoredProcedure,
