...
namespace MLunarCoffee.Pages.Disease
{
    public class DiseaseTypeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("YYY_sp_DiseaseType_Load", CommandType.StoredProcedure);
            }
            if (dt != null)
            {
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id )
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("YYY_sp_DiseaseType_Delete", CommandType.StoredProcedure,
