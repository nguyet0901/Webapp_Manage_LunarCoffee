    ...
    public class DentistChartDiseaseListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string curid)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
              {
                  using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                  {
                      ...
                      dt = await confunc.ExecuteDataTable("[YYY_sp_Dentist_Chart_Disease_LoadList]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
           {
               ...
               {
                   DataTable dt = new DataTable();
                   dt = await confunc.ExecuteDataTable("[YYY_sp_Dentist_Chart_DiseaseCat]", CommandType.StoredProcedure);
                   dt.TableName = "Cat";
                   return dt;
               }
           }));
        ...
        public async Task<IActionResult> OnPostDisableItem(int id,int active)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Dentist_Chart_Disease_Disable]", CommandType.StoredProcedure,
