    ...
    public class LaboChangeStatusModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostInitialize(string currentid)
        {
            ...
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_Labo_LoadNextStatus", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData (string data, string CurrentID)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        dt =await connFunc.ExecuteDataTable("[MLU_sp_Labo_ChangeStatus]", CommandType.StoredProcedure,
                            "@CurrentID", SqlDbType.Int, CurrentID,
