        ...
        public async Task<IActionResult> OnPostLoadData(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("[MLU_sp_Labo_LoadDetail_ChangeSub]", CommandType.StoredProcedure
         ...
         public async Task<IActionResult> OnPostGetPrice(int CurrentID, int Sub)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("[MLU_sp_Labo_ChangeSub_GetPrice]", CommandType.StoredProcedure
                        , "@CurrentID", SqlDbType.Int, CurrentID
         ...
         public async Task<IActionResult> OnPostChangePrice(int CurrentID, string unitprice, string price, int sub,string content)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("[MLU_sp_Labo_ChangeSub_ChanePrice]", CommandType.StoredProcedure
                        , "@CurrentID", SqlDbType.Int, CurrentID
