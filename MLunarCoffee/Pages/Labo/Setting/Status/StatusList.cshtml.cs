    ...
    public class StatusListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Setting_Status_LoadList]" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostStatusFollowLoad(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Setting_Status_LoadStausFollow]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostInfoDetailLoad(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Setting_Status_LoadDetail]" ,CommandType.StoredProcedure
                        ,"@CurrentID" ,SqlDbType.NVarChar ,CurrentID
                        );
                }
                return Content(Comon.DataJson.Datatable(dt));
        ...
        public async Task<IActionResult> OnPostExecuteInfo(string CurrentID ,string Data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Setting_Status_Update]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostStatusFollowUpdate(string CurrentID ,string StatusFollow)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Setting_Status_StatusFollowUpdate]" ,CommandType.StoredProcedure
