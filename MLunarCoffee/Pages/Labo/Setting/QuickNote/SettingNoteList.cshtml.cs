    ...
    public class SettingQuickNoteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Labo_Setting_QuickNote_Load]", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostDelete(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Labo_Setting_QuickNote_Delete]", CommandType.StoredProcedure
