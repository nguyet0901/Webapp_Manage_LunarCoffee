    ...
    public class DiscountListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDataDiscount(string date,string branchID)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt=await confunc.ExecuteDataTable("MLU_sp_Discount_LoadList",CommandType.StoredProcedure,
                    "@UserID",SqlDbType.Int,user.sys_userid,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Discount_Delete]",CommandType.StoredProcedure,
