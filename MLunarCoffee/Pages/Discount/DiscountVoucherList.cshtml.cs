    ...
    public class DiscountVoucherListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(string date, string branchID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Discount_Voucher_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Discount_Voucher_Delete]", CommandType.StoredProcedure,
