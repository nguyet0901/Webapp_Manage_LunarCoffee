    ...
    public class SmsDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInitiallize(int CustomerID ,int TicketID ,int PaymentStudentID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_Customer_SMS_LoadByCustomerOrTicket" ,CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_SMS_Detail_Option_LoadCombo" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_ST_SMS_LoadByStudent" ,CommandType.StoredProcedure
            ...
            ,string contentid ,string treatid ,string paymentid ,string lefttreat ,string lefttab ,string date)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_SMS_LoadContentToSend" ,CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
        //        {
        //            await connFunc.ExecuteDataTable("[YYY_sp_Customer_SMS_Insert]", CommandType.StoredProcedure,
