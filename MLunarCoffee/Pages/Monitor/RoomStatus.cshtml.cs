    ...
    public class RoomStatusModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInit(int RoomID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Manufacture_Room_Info]" ,CommandType.StoredProcedure ,"@RoomID" ,SqlDbType.Int ,RoomID);
                    dt.TableName = "Room";
                    ds.Tables.Add(dt);
                }
        ...
        public async Task<IActionResult> OnPostLoadApps(int RoomID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Monitor_RoomStatus_Schedule]" ,CommandType.StoredProcedure ,"@RoomID" ,SqlDbType.Int ,RoomID);
