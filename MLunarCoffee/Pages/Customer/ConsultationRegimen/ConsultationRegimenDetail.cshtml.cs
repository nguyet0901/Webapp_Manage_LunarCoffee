...
namespace MLunarCoffee.Pages.Customer.ConsultationRegimen
{
    ...
    public class ConsultationRegimenDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Consultation_Anamnesis_Type_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Anamnesis_Type_Insert]", CommandType.StoredProcedure,
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                        await connFunc.ExecuteDataTable ("[MLU_sp_Anamnesis_Type_Update]", CommandType.StoredProcedure,
                            "@Name ", SqlDbType.NVarChar, DataMain.Name.Replace ("'", "").Trim (),
                            "@Data ", SqlDbType.NVarChar, DataMain.Data.Replace ("'", "").Trim (),
