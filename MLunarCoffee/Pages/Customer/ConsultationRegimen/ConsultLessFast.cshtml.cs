...
namespace MLunarCoffee.Pages.Customer.ConsultationRegimen
{
    ...
    public class ConsultLessFastModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Consult_Less_LoadDetail]", CommandType.StoredProcedure,
            ...
            try {
                ...
                if (CurrentID == "0") {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                        await connFunc.ExecuteDataTable ("[MLU_sp_Customer_Consult_Less_Insert]", CommandType.StoredProcedure,
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                        await connFunc.ExecuteDataTable ("[MLU_sp_Customer_Consult_Less_Update]", CommandType.StoredProcedure,
