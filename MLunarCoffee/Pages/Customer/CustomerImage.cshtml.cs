    ...
    public class CustomerImageModel : PageModel
    {
        ...
        public  async Task<IActionResult> OnPostLoadAllFolder(string CustomerID)
        {
            try
            {
                ...
                {
                    dt =  await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_GetList]", CommandType.StoredProcedure,
            ...
            , string type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ds =await connFunc.ExecuteDataSet("[MLU_sp_CustomerImage_GetDetail]", CommandType.StoredProcedure,
        ...
        public  async Task<IActionResult> OnPostInsertImage(string type, string folderid, string name, string realname,string namefeature, string sizebyte)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_Create_Image]", CommandType.StoredProcedure,
        ...
        public  async Task<IActionResult> OnPostDeleteFolder(string customer, string id, string name)
        {
            try
            {
                ...
                if (Comon.Comon.DeleteDirectoryFTP(customer, name))
                {
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dtRes = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_Delete_Folder]", CommandType.StoredProcedure,
                ...
                if (type == "1")
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                            {
                                await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_Delete_Image]", CommandType.StoredProcedure,
        ...
        public  async Task<IActionResult> OnPostLoadTemplateForm()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_GetTemplate]", CommandType.StoredProcedure
                    );
                }
                if (dt != null)
                {
        ...
        public  async Task<IActionResult> OnPostLoadImgByForm(int FolderID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_GetByForm]", CommandType.StoredProcedure,
                        "@FolderID", SqlDbType.Int, FolderID
                    );
                }
                if (dt != null)
        ...
        public  async Task<IActionResult> OnPostInsertImgForm(string folderid, string templateid, string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_UpdateImgForm]", CommandType.StoredProcedure,
                        "@FolderID", SqlDbType.Int, folderid
        ...
        public async Task<IActionResult> OnPostExeSH(string imgid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                     dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_ExeSH]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostGetSizeInDay()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_GetSizeInDay]" ,CommandType.StoredProcedure);
                }
                return Content(Comon.DataJson.Datatable(dt));
