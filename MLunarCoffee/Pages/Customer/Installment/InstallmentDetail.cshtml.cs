    ...
    public class InstallmentDetail : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDetail(string TabID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InstallmentDetailEdit]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostCancel(string TabID)
        {
            try
            {
                ...
                {
                    DataTable dtForm = new DataTable();
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InstallmentDetailCancel]", CommandType.StoredProcedure
                         , "@TabID", SqlDbType.Int, TabID
        ...
        public async Task<IActionResult> OnPostExecuted(string TabID,string term,string preamount,string dayinmonth)
        {
            try
            {
                ...
                {
                    DataTable dtForm = new DataTable();
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InstallmentDetailSave]", CommandType.StoredProcedure
                         , "@TabID", SqlDbType.Int, TabID
