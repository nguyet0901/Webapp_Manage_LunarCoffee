    ...
    public class PaymentDetailReturnModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtPayment = await confunc.ExecuteDataTable("MLU_sp_Customer_PaymentDetail_Return_LoadNew" ,CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtReasonReturn = await confunc.ExecuteDataTable("MLU_sp_Customer_Desposit_Reason_Return" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string dataDetail ,string CustomerID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_Customer_Payment_Return_Insert" ,CommandType.StoredProcedure ,
