...
namespace SourceMain.Pages.Customer.Payment
{
    ...
    public class InstallmentDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDataUpdate(int CurrentID)
        {
            try
            {
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Installment_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string currentTab, string totalStep)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_TabInstallment_Update]", CommandType.StoredProcedure,
