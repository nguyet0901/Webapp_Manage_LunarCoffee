            ...
            try
            {
                ...
                switch (Type)
                {
                    case "consult":
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_TabCommission_LoadComBo_Service]" ,CommandType.StoredProcedure ,
                    ...
                    case "tele":
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_TeleCommission_LoadComBo_Service]" ,CommandType.StoredProcedure ,
                                "@CustomerID" ,SqlDbType.Int ,CustomerID ,
                                "@CurrentID" ,SqlDbType.Int ,CurrentID ,
                                "@DateFrom" ,SqlDbType.DateTime ,Comon.Comon.StringDMY_To_DateTime(DateFrom) ,
                                "@DateTo" ,SqlDbType.DateTime ,Comon.Comon.StringDMY_To_DateTime(DateTo) ,
                    ...
                    case "doctor":
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_TreatCommission_LoadComBo_Service]" ,CommandType.StoredProcedure ,
                    ...
                    case "assistant":
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_AssistantCommission_LoadComBo_Service]" ,CommandType.StoredProcedure ,
                                "@Customer_ID" ,SqlDbType.Int ,CustomerID ,
                                "@CurrentID" ,SqlDbType.Int ,CurrentID ,
                                "@DateFrom" ,SqlDbType.DateTime ,Comon.Comon.StringDMY_To_DateTime(DateFrom) ,
                                "@DateTo" ,SqlDbType.DateTime ,Comon.Comon.StringDMY_To_DateTime(DateTo) ,
            ...
            try
            {
                ...
                switch (type)
                {
                    case "consult":
                        ...
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabCommission_Multi_Insert]" ,CommandType.StoredProcedure ,
                    ...
                    case "tele":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TeleCommission_Multi_Insert]" ,CommandType.StoredProcedure ,
                               "@TabID" ,SqlDbType.Int ,serviceTab ,
                               "@CustomerID" ,SqlDbType.Int ,customerID ,
                               "@Note" ,SqlDbType.NVarChar ,(note != null) ? note.Replace("'" ,"").Trim() : "" ,
                               "@IsChooseDate" ,SqlDbType.Int ,user.sys_ChooseDateCustomer ,
                    ...
                    case "doctor":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TreatCommission_Multi_Insert]" ,CommandType.StoredProcedure ,
                    ...
                    case "assistant":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_AssistantCommission_Multi_Insert]" ,CommandType.StoredProcedure ,
                                "@TreatID" ,SqlDbType.Int ,serviceTab ,
                                "@CustomerID" ,SqlDbType.Int ,customerID ,
                                "@Note" ,SqlDbType.NVarChar ,(note != null) ? note.Replace("'" ,"").Trim() : "" ,
                                "@IsChooseDate" ,SqlDbType.Int ,user.sys_ChooseDateCustomer ,
