    ...
    public class PaymentCardDetailReturnModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain(string CustomerID)
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Card_Payment_Return_LoadNew]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string customerID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Card_Payment_Return_Insert]" ,CommandType.StoredProcedure ,
