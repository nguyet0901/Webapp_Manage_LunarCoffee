    ...
    public class PaymentDetail_QuickNote : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id ,int type)
        {
            ...
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Payment_QuickNote_LoadDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteData(int id ,string data ,string type)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_QuickNote]" ,CommandType.StoredProcedure ,
