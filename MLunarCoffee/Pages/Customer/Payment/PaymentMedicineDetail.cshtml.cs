    ...
    public class PaymentMedicineDetailModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtPrescription = await confunc.ExecuteDataTable("MLU_sp_Customer_Medicine_Payment_LoadCombo" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadDataMed(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Customer_Medicine_Payment_LoadListDetailV2]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string dataDetail ,string CustomerID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Medicine_Payment_InsertV2]" ,CommandType.StoredProcedure ,
