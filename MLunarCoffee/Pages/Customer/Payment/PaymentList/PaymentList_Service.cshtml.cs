    ...
    public class PaymentList_ServiceModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadataPayment(string CustomerID ,string CurrentID ,string CurrentType)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_Payment_Service_Deposit_LoadList2]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostRemoveEInvoice(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Remove_EInvoice]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostUpdateEInvoice(int id ,string EInvoice)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Update_EInvoice]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,id ,
                         "@User" ,SqlDbType.Int ,user.sys_userid ,
        ...
        public async Task<IActionResult> OnPostGetSign_Payment(int id ,string type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Get_Sign]" ,CommandType.StoredProcedure ,
            ...
            try
            {
                ...
                switch (type)
                {
                    case "payment":
                        {
                            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                            {
                                dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Update_Sign]" ,CommandType.StoredProcedure ,
                                    "@CurrentID" ,SqlDbType.Int ,id ,
                                    "@userID" ,SqlDbType.Int ,user.sys_userid ,
                    ...
                    case "deposit":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Deposit_Update_Sign]" ,CommandType.StoredProcedure ,
                            "@CurrentID" ,SqlDbType.Int ,id ,
                            "@userID" ,SqlDbType.Int ,user.sys_userid ,
                            "@Sign" ,SqlDbType.NVarChar ,sign
                            );
            ...
            try
            {
                ...
                switch (type)
                {
                    case "payment":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Delete]" ,CommandType.StoredProcedure ,
                                "@CurrentID" ,SqlDbType.Int ,id ,
                    ...
                    case "deposit":
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Deposit_Delete]" ,CommandType.StoredProcedure ,
                                "@CurrentID" ,SqlDbType.Int ,id ,
                                 "@CustomerID" ,SqlDbType.Int ,customerID ,
                                "@userID" ,SqlDbType.Int ,user.sys_userid
                            );
        ...
        public async Task<IActionResult> OnPostUnlockpayment(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Extension_UnClock_Payment]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,id
                    );
                }
                return Content("1");
        ...
        public async Task<IActionResult> OnPostPaymentMarkColor(int id ,string colorcode)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Update_MarkColor]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,id ,
