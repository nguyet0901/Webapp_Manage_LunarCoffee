        ...
        public void OnGet ( ) {
         ...
         public async Task<IActionResult> OnPostLoadataTabCommissionCard ( int CustomerID, string Limit, string BeginID) {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                dt1 =await  confunc.ExecuteDataTable ("[YYY_sp_Customer_Card_Commission_LoadList]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostDeleteItemCommissionCard ( int id ) {
            try {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                    await connFunc.ExecuteDataTable ("[YYY_sp_Customer_Card_Commission_Delete]", CommandType.StoredProcedure,
