    ...
    public class PaymentList_CardModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadataPaymentCard(string CustomerID ,int IsTiny ,int id ,int limit ,int beginID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Card_Payment_LoadList]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostGetSign_Payment(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_PaymentCard_Get_Sign]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostUpdateSign_PaymentCard(int id ,string sign)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Card_Payment_Update_Sign]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostDeleteItemCard(int id ,string CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Card_Payment_Delete]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,id ,
        ...
        public async Task<IActionResult> OnPostPaymentCardMarkColor(int id ,string colorcode)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Card_Update_MarkColor]" ,CommandType.StoredProcedure ,
                         "@CurrentID" ,SqlDbType.Int ,id ,
