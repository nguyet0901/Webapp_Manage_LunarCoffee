    ...
    public class TreatMultiv2Model : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("MLU_sp_v3_Customer_Treatment_LoadService" ,CommandType.StoredProcedure ,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("MLU_sp_v3_GetTreatmentStage" ,CommandType.StoredProcedure);
                        dt.TableName = "Stage";
                        return dt;
                    }
                }));
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_v3_Customer_Treatment_LoadNote]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_ContentTemplateTreat_LoadCombo]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("[MLU_sp_Treat_LoadPercent]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadTab(string Tab ,string TreatID ,string dencos)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_v3_Customer_Treatment_LoadTab" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadDataUpdate(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_v3_Customer_Treatment_LoadDetail" ,CommandType.StoredProcedure ,
           ...
           ,string UsingDateCustomer)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dtres = await connFunc.ExecuteDataTable("MLU_sp_v3_Customer_TreatMulti_Insert" ,CommandType.StoredProcedure ,
                             "@Customer_ID" ,SqlDbType.Int ,CustomerID ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtres = await connFunc.ExecuteDataTable("MLU_sp_v3_Customer_TreatMulti_Update" ,CommandType.StoredProcedure ,
