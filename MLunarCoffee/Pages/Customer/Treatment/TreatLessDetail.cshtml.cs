...
namespace MLunarCoffee.Pages.Customer.Treatment
{
    ...
    public class TreatLessDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_TreatmentLess_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadComboMain(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt2 = await confunc.ExecuteDataTable("[MLU_sp_CustomerTreatment_PatientRecord_LoadCombo]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TreatmentLess_Insert]", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TreatmentLess_Update]", CommandType.StoredProcedure,
                            "@CustomerID", SqlDbType.Int, DataMain.CustomerID,
                            "@Doctor", SqlDbType.Int, DataMain.Doctor,
                            "@Assist", SqlDbType.Int, DataMain.Assist,
                            "@PatientID", SqlDbType.Int, DataMain.PatientID,
