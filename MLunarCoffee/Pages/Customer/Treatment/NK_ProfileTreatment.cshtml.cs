        ...
        public void OnGet ( ) {
         ...
         public async Task<IActionResult> OnPostLoadataProfileTreat ( int CustomerID ) {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                ...
                dt =await  confunc.ExecuteDataTable ("[MLU_sp_Customer_LoadProfilePrint]", CommandType.StoredProcedure,
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                DataTable dt = new DataTable ();
                dt =await  confunc.ExecuteDataTable ("[MLU_sp_Customer_Treatment_LoadPrint]", CommandType.StoredProcedure,
