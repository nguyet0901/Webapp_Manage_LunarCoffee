    ...
    public class TreatWorkListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(string CustomerID, int id, int limit, int beginID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_Treatment_Work_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_Work_Delete]", CommandType.StoredProcedure,
