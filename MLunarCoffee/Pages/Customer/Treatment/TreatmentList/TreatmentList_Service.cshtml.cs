    ...
    public class TreatmentList_ServiceModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt2 = await confunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_PatientRecord_LoadCombo]", CommandType.StoredProcedure
                ...
                //    dt1 = await confunc.ExecuteDataTable("[YYY_sp_ServiceStage_Load]", CommandType.StoredProcedure);
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_TreatmentPlan_LoadCombo]", CommandType.StoredProcedure
                        , "@CustomerID", SqlDbType.Int, CustomerID);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_TabService_LoadCombo]", CommandType.StoredProcedure
                        , "@CustomerID", SqlDbType.Int, CustomerID);
        ...
        public async Task<IActionResult> OnPostLoadataTreatment(int CustomerID, int PatientRecordID, int TreatmentPlanID, int ServiceTabID, int idbegin, int idbeginless, int limit)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_v2_Customer_Treatment_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem_Treat_Record(int id, string CustomerId)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_TreatmentLess_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem_Treat_Service(int id, int tabid, int dencos, string CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_v3_Customer_Treatment_Delete]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
        ...
        public async Task<IActionResult> OnPostGetSign_Treatment(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_Get_Sign]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostUpdateSignTreatment(int id, string sign)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_Update_Sign]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@userID", SqlDbType.Int, user.sys_userid,
        ...
        public async Task<IActionResult> OnPostUpdateSignAllday(int id, int customerid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_Update_SignAllDay]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@CustomerID", SqlDbType.Int, customerid,
                        "@userID", SqlDbType.Int, user.sys_userid
                    );
