    ...
    public class GeneralInfoModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadIni(string custID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("MLU_sp_ListTele" ,CommandType.StoredProcedure);
                        dt.TableName = "Tele";
                        return dt;
                    }
                }));
        ...
        public async Task<IActionResult> OnPostLoadata(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Customer_LoadGeneralInfo]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostBackStatus(string appID)
        {
            try
            {
                ...
                if (appID != "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_Customer_Appointment_BackStatus" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadCustomerGroup(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_Customer_Group_Customer_Load" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadCustCare(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_CustomerInfo_EmpLoad" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        public async Task<IActionResult> OnPostLoadRelation(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ds = await connFunc.ExecuteDataSet("MLU_sp_Customer_Relationship_Load" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,custID ,
        ...
        public async Task<IActionResult> OnPostLoadHistory(string CustomerID)
        {
            try
            {
                ...
                if (CustomerID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_Customer_LoadInfo_History" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadAnamnesis(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_Customer_Anamnesis_LoadLastDetail" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadConsultStatus(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_ConsultStatus" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        //            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
        //            {
        //                dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_Overview", CommandType.StoredProcedure,
        //                    "@CustID", SqlDbType.Int, custID
        //                );
        //            }
        //        }
        ...
        public async Task<IActionResult> OnPostLoadService(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_Service" ,CommandType.StoredProcedure ,
                            "@CustID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        public async Task<IActionResult> OnPostLoadProperties(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_CustomerProperties_Load]" ,CommandType.StoredProcedure ,
                            "@CustID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        public async Task<IActionResult> OnPostLoadTreat(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_Treat" ,CommandType.StoredProcedure ,
                            "@CustID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        public async Task<IActionResult> OnPostLoadPayment(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_Payment" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,custID
                        );
                    }
                }
        ...
        public async Task<IActionResult> OnPostLoadRating(string custID ,string branchID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_AC_Rating_LoadByCust" ,CommandType.StoredProcedure ,
                            "@CustID" ,SqlDbType.Int ,custID ,
        ...
        public async Task<IActionResult> OnPostLoadBroker(string custID)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YMLU_sp_Customer_LoadInfo_Broker" ,CommandType.StoredProcedure ,
