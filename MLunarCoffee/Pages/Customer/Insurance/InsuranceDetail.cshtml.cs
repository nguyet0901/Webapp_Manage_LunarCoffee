    ...
    public class InsuranceDetail : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDetail(string TabID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                       DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InsurDetailEdit]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostCancel(string TabID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InsurDetailCancel]", CommandType.StoredProcedure
                         , "@TabID", SqlDbType.Int, TabID
        ...
        public async Task<IActionResult> OnPostExecuted(string TabID, string insuranceid, string insuramount)
        {
            try
            {
                ...
                {
                    DataTable dtForm = new DataTable();
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_InsurDetailSave]", CommandType.StoredProcedure
                         , "@TabID", SqlDbType.Int, TabID
