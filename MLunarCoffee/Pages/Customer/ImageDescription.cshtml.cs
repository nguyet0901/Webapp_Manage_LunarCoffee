...
namespace MLunarCoffee.Pages.Customer
{
    public class ImageDescriptionModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata ( int id)
        {
            ...
            {
                dt =await  confunc.ExecuteDataTable("[MLU_sp_CustomerImage_Description_Load]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostExcuteData ( string data, string CurrentID)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_CustomerImage_Description_Update]", CommandType.StoredProcedure,
