...
namespace MLunarCoffee.Pages.Customer
{
    ...
    public class RelationshipDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitialization()
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[YYY_sp_Relationship_LoadCombo]" ,CommandType.StoredProcedure);
            }
            if (dt != null)
            {
        ...
        public async Task<IActionResult> OnPostLoadata(int custID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_Relationship_Load]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadataRelationship(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Relationship_Load]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteData(string custID ,string custselected ,string ralid ,string rela1)
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt=await connFunc.ExecuteDataTable("YYY_sp_Customer_Relationship_Update" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostDeleteData(string currentid,string custid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("YYY_sp_Customer_Relationship_Delete" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostSearchCustomer(string custID ,string keyword)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Searching_Customer_Relationship]" ,CommandType.StoredProcedure ,
