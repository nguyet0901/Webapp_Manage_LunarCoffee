    ...
    public class PatientRecordDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInitializeData(string customerID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                ...
                dt = await confunc.ExecuteDataTable("[YYY_sp_PatientRecord_LoadCombo]", CommandType.StoredProcedure
            ...
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_StatusTeeth_LoadCombo]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            ds = await confunc.ExecuteDataSet("[YYY_sp_Patient_Record_Load_Teeth_Detail]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadata(int CurrentID, int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_Patient_Record_Detail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID, string CustomerID)
        {
            try
            {
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_PatientRecord_Update]", CommandType.StoredProcedure,
                             "@DataTemplate", SqlDbType.NVarChar, DataMain.DataTemplate.Replace("'", "").Trim(),
                             "@StatusTeethID", SqlDbType.Int, DataMain.StatusTeethID,
        ...
        public async Task<IActionResult> OnPostExcuteDelete(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_PatientRecord_Delete]", CommandType.StoredProcedure,
