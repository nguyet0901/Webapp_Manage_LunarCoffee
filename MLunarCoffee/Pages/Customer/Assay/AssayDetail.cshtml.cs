            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtForm = await confunc.ExecuteDataTable("[MLU_sp_print_v2_GetForm]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtField = await confunc.ExecuteDataTable("[MLU_sp_print_v2_Assay]", CommandType.StoredProcedure
