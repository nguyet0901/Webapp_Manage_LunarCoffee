    ...
    public class DiagnoseListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string CustomerID,string ICDArea)
        {
            ...
            tasks.Add(Task.Run(async () =>
           {
               ...
               {
                   DataTable dt = new DataTable();
                   dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Diagnose_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Customer_Diagnose_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadIni(string CustomerID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Diagnose_BSign]", CommandType.StoredProcedure);
