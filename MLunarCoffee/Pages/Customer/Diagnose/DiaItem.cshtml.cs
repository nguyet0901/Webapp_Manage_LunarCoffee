             ...
             ,string Note,string Type)
        {
            try
            {
                ...
                if(CurrentID=="0")
                {
                    ...
                    {
                        DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_DiagItem_Insert]",CommandType.StoredProcedure,
                ...
                else
                {
                    using(Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        await connFunc.ExecuteDataTable("[MLU_sp_Customer_DiagItem_Update]",CommandType.StoredProcedure,
                            "@dataSVG",SqlDbType.NVarChar,dataSVG,
                            "@dataQues",SqlDbType.NVarChar,dataQues,
                             "@StatusICD" ,SqlDbType.NVarChar ,StatusICD ,
                            "@dataFree" ,SqlDbType.NVarChar,dataFree,
