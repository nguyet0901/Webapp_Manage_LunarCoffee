...
namespace MLunarCoffee.Pages.Customer
{
    ...
    public class StatusDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Status_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadInitializeData()
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("MLU_sp_Service_Combo_Load", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("MLU_sp_Product_Combo_Product_NotMedicine", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("[MLU_sp_CustomerStatus_LoadType]", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CustomerID, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        await connFunc.ExecuteDataTable("MLU_sp_Customer_Status_Insert", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        await connFunc.ExecuteDataTable("MLU_sp_Customer_Status_Update", CommandType.StoredProcedure,
