    ...
    public class StatusListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadataStatus(string CustomerID, int id, int limit, int beginID, int Type, int TypeParent)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_Customer_Status_Load", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Customer_Status_Delete]", CommandType.StoredProcedure,
