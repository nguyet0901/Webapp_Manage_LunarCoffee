...
namespace MLunarCoffee.Pages.Customer
{
    public class ComplaintListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int CustomerID ,int currentID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                ds = await confunc.ExecuteDataSet("[MLU_sp_Customer_Complaint_LoadList]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadataDetail(int CurrentID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Complaint_LoadDetail]" ,CommandType.StoredProcedure
                  ,"@CurrentID" ,SqlDbType.Int ,CurrentID
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Customer_Complaint_Delete]" ,CommandType.StoredProcedure ,
                        "@ID" ,SqlDbType.Int ,id ,
