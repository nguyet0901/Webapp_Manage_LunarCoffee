        ...
        public void OnGet ( ) {
            ...
            try {
                ...
                if (custID != "0") {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                        dt =await connFunc.ExecuteDataTable ("YYY_sp_Customer_Commitment_LoadList", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostDeleteItemCommitment ( string id ) {
            try {
                ...
                if (id != "0") {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                        dt =await connFunc.ExecuteDataTable ("YYY_sp_Customer_Commitment_Delete", CommandType.StoredProcedure,
