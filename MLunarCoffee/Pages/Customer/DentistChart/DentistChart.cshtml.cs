    ...
    public class DentistChartModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoad_Chart_Teeth_List(string customerid, int id, int limit, int beginID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                ...
                dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Chart_Teeth_LoadList]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            ...
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Customer_Dentist_Chart_Delete]", CommandType.StoredProcedure,
