    ...
    public class TabComboMultiModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtServiceCombo = await confunc.ExecuteDataTable("YYY_sp_Customer_Tab_Service_ComboType_Load" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtSourceService = new DataTable();
                        dtSourceService = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabMulti_LoadComboTele]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExecuteData(string data ,string CustomerID ,string Patient ,string Plan ,string Plan_Name, string ComboID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("YYY_sp_Customer_TabComboMulti_Insert" ,CommandType.StoredProcedure ,
