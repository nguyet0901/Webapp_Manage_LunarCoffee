    ...
    public class TabList_ServiceModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInitialize(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("MLU_sp_v2_Customer_Tab_Treatment_Plan_Status_Load", CommandType.StoredProcedure);
                    dt.TableName = "Status";
                    ds.Tables.Add(dt);
                }
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("MLU_sp_v2_Customer_PatientRecord_TabService_LoadList", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadataTab(int CustomerID, int Record, int Plan, int ViewAll)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_v2_Customer_TabService_LoadList", CommandType.StoredProcedure,
                      "@Customer_ID", SqlDbType.Int, CustomerID
        ...
        public async Task<IActionResult> OnPostLoadInfo_Treatment_Plant(string custID, string plantid)
        {
            try
            {
                ...
                if (custID != "0")
                {
                    ...
                    {
                        ds = await connFunc.ExecuteDataSet("MLU_sp_Customer_TreatmentPlan_Info", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostTabService_Change_Choose(string data, string customerid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabService_Change_Choose]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabService_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLockAndUnlockTab(int id, int type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabService_ChangeLock]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
        ...
        public async Task<IActionResult> OnPostLoadServiceTab()
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Tab_Service_Load]", CommandType.StoredProcedure,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Tab_Service_Type]", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostDisableAndUndisableTab(int id, int type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabService_ChangeDisable]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@Type", SqlDbType.Int, type,
                        "@userID", SqlDbType.Int, user.sys_userid
                    );
        ...
        public async Task<IActionResult> OnPostFinishTab(int id, int type)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_TabService_ChangeFinish]", CommandType.StoredProcedure,
                         "@CurrentID", SqlDbType.Int, id,
                         "@Type", SqlDbType.Int, type,
                         "@userID", SqlDbType.Int, user.sys_userid
                     );
        ...
        public async Task<IActionResult> OnPostPatient_Record_Checking_Button(int RecordID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_v2_Customer_PatientRecord_TabService_Checking_Button", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
        //        {
        //            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_PatientRecord_IsClose]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt = await confunc.ExecuteDataTable("MLU_sp_v2_Customer_Tab_Treatment_Plan_LoadList_Compare", CommandType.StoredProcedure,
        //              "@CustomerID", SqlDbType.Int, CustomerID
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt = await confunc.ExecuteDataTable("MLU_sp_v2_Customer_Tab_Treatment_Plan_Checking_Button", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostIsCloseTreatmentPlan(int TreatmentPlanID, int Status)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt =  await connFunc.ExecuteDataTable("[MLU_sp_Customer_Treatment_Plan_IsClose]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDelete_Treatment_Plan(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Treatment_Plan_Delete]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@userID", SqlDbType.Int, user.sys_userid);
                    return Content(Comon.DataJson.GetFirstValue(dt));
                }
        ...
        public async Task<IActionResult> OnPostClone_Treatment_Plan(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_v2_Customer_Treatment_Plan_Clone]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@userID", SqlDbType.Int, user.sys_userid,
        ...
        //        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
        //        {
        //            await connFunc.ExecuteDataTable("[MLU_sp_Customer_Treatment_Plan_Choose]", CommandType.StoredProcedure,
        //                "@TreatmentPlanID", SqlDbType.Int, TreatmentPlanID,
        //                "@UserID", SqlDbType.Int, user.sys_userid
        //            );
        //        }
        ...
        public async Task<IActionResult> OnPostLoadImgTreatPlan(int CustomerID, int TreatPlanID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Treatment_Plan_LoadFolder]", CommandType.StoredProcedure,
                      "@CustomerID", SqlDbType.Int, CustomerID,
        ...
        //        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
        //        {
        //            dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Treatment_UpdateSign]", CommandType.StoredProcedure,
        //                "@CurrentID", SqlDbType.Int, id,
        ...
        public async Task<IActionResult> OnPostTreatment_Plan_Status_Exchange(string StatusID, string TreatmentPlantID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_v2_Customer_Tab_Treatment_Plan_Status_Exchange", CommandType.StoredProcedure,
