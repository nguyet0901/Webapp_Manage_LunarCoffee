            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtServiceCard = await confunc.ExecuteDataTable("[YYY_sp_Service_Card_Customer_Combo]", CommandType.StoredProcedure
            ...
            try
            {
                ...
                if (CurrentID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Card_Update]", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Card_Insert]", CommandType.StoredProcedure,
                             "@CustomerID", SqlDbType.Int, Convert.ToInt32(CustomerID),
                             "@CardID", SqlDbType.Int, Convert.ToInt32(DataMain.Rows[0]["CardID"]),
                             "@ConsultID" ,SqlDbType.Int ,Convert.ToInt32(DataMain.Rows[0]["ConsultID"]) ,
                             "@ConsultID1" ,SqlDbType.Int ,Convert.ToInt32(DataMain.Rows[0]["ConsultID1"]) ,
