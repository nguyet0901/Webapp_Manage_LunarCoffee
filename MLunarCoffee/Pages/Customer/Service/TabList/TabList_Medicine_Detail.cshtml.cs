    ...
    public class TabList_Medicine_DetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain(string ICDArea)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Prescription_Medicine_Combo]" ,CommandType.StoredProcedure);
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dtWare = await confunc.ExecuteDataTable("[MLU_sp_Medicine_CheckWareExport]" ,CommandType.StoredProcedure ,
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dsMedicine = await confunc.ExecuteDataSet("[MLU_sp_Medicine_Combo_Load]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadPrescription(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Prescription_Medicine_ComboDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadUpdate(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Customer_Prescription_Medicine_LoadDetail]" ,CommandType.StoredProcedure ,
                          "@CurrentID" ,SqlDbType.Int ,Convert.ToInt32(CurrentID == 0 ? 0 : CurrentID)
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string dataDetail ,string CustomerID ,string CurrentID ,string PatientRecordID ,string IsExportMedicine)
        {
            try
            {
                ...
                if (CurrentID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Prescription_Medicine_Update]" ,CommandType.StoredProcedure ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Prescription_Medicine_Insert]" ,CommandType.StoredProcedure ,
                             "@CustomerID" ,SqlDbType.Int ,Convert.ToInt32(CustomerID) ,
                             "@Name" ,SqlDbType.NVarChar ,!String.IsNullOrEmpty(DataMain.Name) ? DataMain.Name : "" ,
                             "@PrescriptionMedicineID" ,SqlDbType.Int ,Convert.ToInt32(DataMain.PreMedicineID) ,
                             "@PriceDiscounted" ,SqlDbType.Decimal ,DataMain.PriceDiscounted ,
