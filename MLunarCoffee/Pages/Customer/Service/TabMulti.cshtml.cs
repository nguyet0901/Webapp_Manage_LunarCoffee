    ...
    public class TabMultiModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtServiceCombo = await confunc.ExecuteDataTable("YYY_sp_Customer_Tab_Service_Combo_Load" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtDataServiceCat = await confunc.ExecuteDataTable("YYY_sp_v2_Service_Type" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtDataTeeth = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_Load_Teeth]" ,CommandType.StoredProcedure);
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtReasonFree = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_ReasonFree" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtReasonFree = new DataTable();
                        dtReasonFree = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_ReasonDiscount" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtVoucher = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_Voucher" ,CommandType.StoredProcedure ,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtDiscount = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_Discount" ,CommandType.StoredProcedure ,
                            "@Branch_ID" ,SqlDbType.Int ,user.sys_branchID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtInsurance = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_Insurance" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtDiscountTab = await confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadComBo_ALL_Discount" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtPatient = await confunc.ExecuteDataTable("[YYY_sp_Customer_PatientRecord_LoadCbb]" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,CustomerID ,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtCard = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_LoadCard]" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,CustomerID ,
                            "@CurrentID" ,SqlDbType.Int ,CurrentID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtGroupCus = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_LoadComBo_GroupCustomer]" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,CustomerID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtGroupCus = new DataTable();
                        dtGroupCus = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_LoadComBo_MemberCustomer]" ,CommandType.StoredProcedure ,
                            "@CustomerID" ,SqlDbType.Int ,CustomerID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtRule_Teeth = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_Load_Teeth_Rule]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtCustomer_Rule_Teeth = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_TeethRule_Customer]" ,CommandType.StoredProcedure
                            ,"@CustomerID" ,SqlDbType.Int ,CustomerID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtNote_Service = await confunc.ExecuteDataTable("[YYY_sp_Customer_Tab_Load_NoteService]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtStaff = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabMulti_LoadComboTele]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Tab_GetAmountPoint]" ,CommandType.StoredProcedure
                            ,"@CustomerID" ,SqlDbType.Int ,CustomerID);
           ...
           ,string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Customer_TabMulti_Insert" ,CommandType.StoredProcedure ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Customer_TabMulti_Update" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadDataDetail(int currentid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Customer_TabService_LoadDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExecuting_Patient_Record(string TemplateID ,string CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_PatientRecord_Insert]" ,CommandType.StoredProcedure ,
                        "@Customer_ID" ,SqlDbType.Int ,CustomerID ,
        ...
        public async Task<IActionResult> OnPostChecked_Patient_Record_Template(string TokentService)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_Customer_Tab_Service_Check_Patient" ,CommandType.StoredProcedure ,
