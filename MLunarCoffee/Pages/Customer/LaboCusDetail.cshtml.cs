    ...
    public class LaboCusDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInitialize(string CustomerID, string CurrentID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Labo_Service_Supplier]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Labo_LoadComboService]", CommandType.StoredProcedure,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_TabService_Load_Teeth]", CommandType.StoredProcedure);
                        dt.TableName = "Teeth";
                        return dt;
                    }
                }));
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_LaboTemplate_LoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_LaboWarantly_LoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Labo_Customer_LoadDetail]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("[YYY_sp_Labo_Customer_LoadProperties]", CommandType.StoredProcedure,
                         "@ID", SqlDbType.Int, Convert.ToInt32(CurrentID));
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string properties, string CurrentID, string CustomerID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Customer_Insert]", CommandType.StoredProcedure,
                            "@Customer_ID", SqlDbType.Int, CustomerID,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Customer_Update]", CommandType.StoredProcedure,
                            "@tabID", SqlDbType.Int, DataMain.TabID,
                            "@Doctor_ID", SqlDbType.Int, DataMain.IDDoctor,
                            "@LaboLayout", SqlDbType.Int, DataMain.LaboLayout,
                            "@IDWarantly", SqlDbType.Int, DataMain.IDWarantly,
        ...
        public async Task<IActionResult> OnPostUpdate(string data ,string properties ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Customer_UpdateValue]" ,CommandType.StoredProcedure
                        ,"@IDWarantly" ,SqlDbType.Int ,DataMain.IDWarantly
                        ,"@Doctor_ID" ,SqlDbType.Int ,DataMain.IDDoctor
                        ,"@LaboLayout" ,SqlDbType.Int ,DataMain.LaboLayout
                        ,"@UserTo" ,SqlDbType.Int ,DataMain.IDDeliver
        ...
        public async Task<IActionResult> OnPostDelete(int id)
        {
            ...
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Labo_Customer_Delete]" ,CommandType.StoredProcedure ,
