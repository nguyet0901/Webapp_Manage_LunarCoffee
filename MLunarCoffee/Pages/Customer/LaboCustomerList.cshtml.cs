    ...
    public partial class LaboCustomerListModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("MLU_sp_LaboSupplier_Load" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("MLU_sp_LaboColor" ,CommandType.StoredProcedure);
                       dt.TableName = "Color";
                       return dt;
                   }
               }));
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("MLU_sp_LaboDimension" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("MLU_sp_LaboMaterial" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
              {
                  ...
                  {
                      DataTable dt = new DataTable();
                      dt = await confunc.ExecuteDataTable("MLU_sp_LaboTeethLayout" ,CommandType.StoredProcedure);
                      dt.TableName = "Layout";
                      return dt;
                  }
              }));
                tasks.Add(Task.Run(async () =>
               {
                   ...
                   {
                       DataTable dt = new DataTable();
                       dt = await confunc.ExecuteDataTable("MLU_sp_LaboProperties" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadataLaboCusList(string CustomerID ,string LaboID ,int limit ,int beginID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Labo_Customer_LoadList]" ,CommandType.StoredProcedure ,
