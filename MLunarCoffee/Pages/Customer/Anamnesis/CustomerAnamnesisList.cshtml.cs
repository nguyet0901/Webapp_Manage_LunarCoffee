        ...
        public void OnGet ( ) {
         ...
         public async Task<IActionResult> OnPostLoadataPatientHistory ( string CustomerID ) {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                dt =await  confunc.ExecuteDataTable ("[YYY_sp_Customer_Anamnesis_LoadList]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostDeleteItem ( int id ) {
            try {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase ()) {
                    await connFunc.ExecuteDataTable ("[YYY_sp_Customer_Anamnesis_Delete]", CommandType.StoredProcedure,
