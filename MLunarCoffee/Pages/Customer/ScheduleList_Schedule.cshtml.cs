    ...
    public class ScheduleList_ScheduleModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(string CustomerID, int Limit, string BeginID,string IsDelete)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Customer_Schedule_LoadList]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            ...
            {
                dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Schedule_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadSheduleInDay(int CustomerID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Customer_Schedule_Load_ScheduleInDay]", CommandType.StoredProcedure,
