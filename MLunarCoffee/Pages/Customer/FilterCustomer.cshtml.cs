    ...
    public class FilterCustomerModel : PageModel
    {
           ...
           )
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Customer_Filter]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadComboMain()
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("MLU_sp_Service_Type", CommandType.StoredProcedure);
