    ...
    public class LoadCustomerToMergeModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int id)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_Customer_DeleteMerge_LoadDetail", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostSearchingCustomerToMerge(string keyword, string customerFrom)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt =await  confunc.ExecuteDataTable("[YYY_sp_Customer_Merge_Searching_Detination]", CommandType.StoredProcedure,
