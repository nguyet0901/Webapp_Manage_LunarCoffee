    ...
    public class ControlAllowGroupModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            ...
            tasks.Add(Task.Run(async () =>
            {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_PerGetLock]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecuteData(string data, string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("MLU_sp_ControlGroupAllow_Execute", CommandType.StoredProcedure,
