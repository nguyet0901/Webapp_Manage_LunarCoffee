...
namespace MLunarCoffee.Pages.Permission
{
    public class PermissionControlListModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadData()
        {
            ...
            {
                dt =await  confunc.ExecuteDataTable("MLU_sp_Permission_ControlLoad", CommandType.StoredProcedure);
            }
            if (dt != null)
            {
         ...
         public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    DataTable dt =await connFunc.ExecuteDataTable("[MLU_sp_Permission_Control_Delete]", CommandType.StoredProcedure,
