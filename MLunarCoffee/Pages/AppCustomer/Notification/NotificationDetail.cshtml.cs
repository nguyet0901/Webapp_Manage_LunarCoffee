...
namespace MLunarCoffee.Pages.Notification.AppCustomer
{
    public class NotificationDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInit()
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Notification_AC_Article]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExecute(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_AppCustomer_Notification_Insert]" ,CommandType.StoredProcedure ,
