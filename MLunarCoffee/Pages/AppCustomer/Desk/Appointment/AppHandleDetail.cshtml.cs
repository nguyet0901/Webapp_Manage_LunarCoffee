    ...
    public class AppHandleDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostSearchCustomer(string textsearch, int custID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_AC_Schedule_SearchCustomer]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(int appID, int userID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_AC_Schedule_Customer_UpdateUser]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostCancelApp(int CurrentID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_AC_Schedule_CancelApp]", CommandType.StoredProcedure,
