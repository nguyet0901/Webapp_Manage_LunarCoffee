    ...
    public class TicketTagListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain(int userID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_TicketTag_LoadTele]", CommandType.StoredProcedure,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_GroupLoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_Combo_StatusFollowTele]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_Combo_Tag]", CommandType.StoredProcedure);
                        dt.TableName = "Tag";
                        return dt;
                    }
                }));
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_Combo_CreateByUser]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Check_Tele_Permission]", CommandType.StoredProcedure
                            , "@UserID", SqlDbType.Int, userID);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_Combo_CustomerGroup]" , CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadTotal(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_TicketTagList_Total]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadData(string data, int BeginID, int Limit, string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_TicketTagList_Load]" , CommandType.StoredProcedure,
