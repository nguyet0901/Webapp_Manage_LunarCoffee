    ...
    public class TicketDetailModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Type_ComboLoad]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Customer_Group_ComboLoad]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_EmployeeMarketing_LoadCombo]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_TicketTag_LoadTele]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Check_Tele_Permission]", CommandType.StoredProcedure
                            , "@UserID", SqlDbType.Int, user.sys_userid
                            );
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_GetStaffID]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_Tag]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadataTicketDetail(int TicketID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID, string CustomerID, string exist)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Insert]", CommandType.StoredProcedure,
                ...
                else
                {
                    if (CustomerID == "0")
                    {
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Update]", CommandType.StoredProcedure,
                                "@Email", SqlDbType.NVarChar, DataMain.Email.Replace("'", "").Trim(),
                                "@Phone1", SqlDbType.NVarChar, DataMain.Phone.Replace("'", "").Trim(),
                                "@Phone2", SqlDbType.NVarChar, DataMain.Phone2.Replace("'", "").Trim(),
                                "@Name", SqlDbType.NVarChar, DataMain.Name.Replace("'", "").Trim(),
                    ...
                    else
                    {
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Customer_Update]", CommandType.StoredProcedure,
                                "@Content", SqlDbType.NVarChar, DataMain.Content.Replace("'", "").Trim(),
                                "@Email", SqlDbType.NVarChar, DataMain.Email.Replace("'", "").Trim(),
                                "@UrlInstgram", SqlDbType.NVarChar, DataMain.instgramurl.Replace("'", "").Trim(),
                                "@UrlFacebook", SqlDbType.NVarChar, DataMain.facebookurl.Replace("'", "").Trim(),
