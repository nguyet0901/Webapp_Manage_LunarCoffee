    ...
    public class TicketDeleteModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostInitializeCombo()
        {
            try
            {
                ...
                {
                    dt =await connFunc.ExecuteDataTable("[MLU_sp_Ticket_ReasonDelete_LoadCombo]", CommandType.StoredProcedure);
                }
         ...
         public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt =await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Delete]", CommandType.StoredProcedure,
