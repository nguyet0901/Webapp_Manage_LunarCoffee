    ...
    public class StatusSendSMSModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadData()
        {
          ...
          var user = Session.GetUserSession(HttpContext);
            ...
            {
                dt =await connFunc.ExecuteDataTable("[YYY_sp_SMS_MultiMaster_Load]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostLoadDataDetail(string CurrentID)
        {
            ...
            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
            {
                dt =await connFunc.ExecuteDataTable("[YYY_sp_SMS_MultiDetail_Load]", CommandType.StoredProcedure,
