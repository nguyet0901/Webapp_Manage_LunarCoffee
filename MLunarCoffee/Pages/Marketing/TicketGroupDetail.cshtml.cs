    ...
    public class TicketGroupDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_GroupLoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostInitializeTicketGroup(int id)
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_UserName_Update]", CommandType.StoredProcedure,
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_Group]", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_Level]", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_Extension]", CommandType.StoredProcedure,
                        "@Current_ID", SqlDbType.Int, Convert.ToInt32(id == 0 ? 0 : id));
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Group_Insert]", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Group_Update]", CommandType.StoredProcedure,
                            "@User_ID", SqlDbType.Int, DataMain.User_ID,
                            "@Level_ID", SqlDbType.Int, DataMain.Level_ID,
                            "@Group_ID", SqlDbType.Int, DataMain.Group_ID,
                            "@Call_ID", SqlDbType.Int, DataMain.Call_ID,
