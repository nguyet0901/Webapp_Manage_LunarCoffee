    ...
    public class TicketWebsiteModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadInitializeData()
        {
            try
            {
                ...
                {
                    dt1 =await  confunc.ExecuteDataTable("[YYY_sp_Ticket_LoadTele]", CommandType.StoredProcedure,
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt1 =await  confunc.ExecuteDataTable("[YYY_sp_Ticket_Website_LoadList]", CommandType.StoredProcedure);
         ...
         public async Task<IActionResult> OnPostExecute(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    await confunc.ExecuteDataTable("[YYY_sp_Ticket_Website_To_Ticket]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostDeleteTicket(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Ticket_Website_Delete]", CommandType.StoredProcedure,
