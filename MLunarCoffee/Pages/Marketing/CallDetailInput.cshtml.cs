    ...
    public class CallDetailInputModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadUpdate(string currentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_Complaint_LoadValue]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostInitializeCombo(int CurrentID ,int Type ,int TicketID, string CustomerID)
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("MLU_sp_CustomerCare_LoadStatus" ,CommandType.StoredProcedure);
                        dt.TableName = "Status";
                        return dt;
                    }
                }));
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Customer_History_LoadDetail]" ,CommandType.StoredProcedure ,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("MLU_sp_CustomerCare_LoadQuickTeamplate_ByType" ,CommandType.StoredProcedure ,
                ...
                if (TicketID != '0')
                {
                    tasks.Add(Task.Run(async () =>
                    {
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            ...
                            dtTag = await confunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_Tag]" ,CommandType.StoredProcedure);
                            dtTag.TableName = "Tag";
                            return dtTag;
                        }
                    }));
                    tasks.Add(Task.Run(async () =>
                    {
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            ...
                            dtTagDetail = await confunc.ExecuteDataTable("[MLU_sp_Ticket_TagByTicket]" ,CommandType.StoredProcedure ,
                    ...
                    tasks.Add(Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dtTagDetail = new DataTable();
                            dtTagDetail = await confunc.ExecuteDataTable("[MLU_sp_Branch_Load]" ,CommandType.StoredProcedure
                    ...
                    tasks.Add(Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dtTagDetail = new DataTable();
                            dtTagDetail = await confunc.ExecuteDataTable("[MLU_sp_NearestSchedule_Load]" ,CommandType.StoredProcedure
            ...
            try
            {
                ...
                switch (Type_Care)
                {
                    ...
                    case 10:
                        ...
                        {
                            DataTable dt = new DataTable();
                            dt = await connFunc.ExecuteDataTable("MLU_sp_CustomerCare_InsertValue" ,CommandType.StoredProcedure ,
                    ...
                    case 5:
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            ...
                            {
                                DataTable dt = new DataTable();
                                dt = await connFunc.ExecuteDataTable("MLU_sp_CustomerCare_InsertValue_Treatment" ,CommandType.StoredProcedure ,
                    ...
                    case 12:
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            ...
                            {
                                DataTable dt = new DataTable();
                                dt = await connFunc.ExecuteDataTable("MLU_sp_CustomerCare_InsertValue_Self" ,CommandType.StoredProcedure ,
                                 "@CustomerID" ,SqlDbType.Int ,CustomerID ,
                                 "@Type" ,SqlDbType.Int ,Type_Care ,
                                 "@IsDone" ,SqlDbType.Int ,IsDone ,
                                 "@Created_By" ,SqlDbType.Int ,user.sys_userid ,
                    ...
                    case 7: // Tu Ticket
                        ...
                        {
                            //DataTable dt = new DataTable();
                            await connFunc.ExecuteDataTable("MLU_sp_Ticket_Input_Insert" ,CommandType.StoredProcedure ,
                                "@Ticket" ,SqlDbType.Int ,Convert.ToInt32(TicketID) ,
                                "@Typeinput" ,SqlDbType.Int ,DataMain.Typeinput ,
                    ...
                    case 8: // Customer History : Insert and update
                        if (CurrentID == 0)
                        {
                            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                            {
                                await connFunc.ExecuteDataTable("MLU_sp_Customer_History_Insert" ,CommandType.StoredProcedure ,
                        ...
                        else
                        {
                            using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                            {
                                await connFunc.ExecuteDataTable("MLU_sp_Customer_History_Update" ,CommandType.StoredProcedure ,
                                    "@Content" ,SqlDbType.NVarChar ,content != null ? content.Replace("'" ,"").Trim() : "" ,
                                    "@Created_By" ,SqlDbType.Int ,user.sys_userid ,
                                    "@Type" ,SqlDbType.Int ,DataMain.StatusCallDetail ,
