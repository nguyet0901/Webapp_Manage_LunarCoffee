    ...
    public class TicketFile_File_ConvertCustomerModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dtBranch = await confunc.ExecuteDataTable("MLU_sp_Branch_Load_Change" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadDetail(string ImportID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Ticket_File_ConvertCust_LoadDetail]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecute(string data, string branchid, string allowduplicate)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_File_ConvertCust_Insert]" ,CommandType.StoredProcedure
