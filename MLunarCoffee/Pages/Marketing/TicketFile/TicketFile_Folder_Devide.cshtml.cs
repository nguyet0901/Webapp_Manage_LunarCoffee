        ...
        public async Task<IActionResult> OnPostLoadDataInitialize(int FileID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_File_Folder_Last_Devide_v2]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, int FileID)
        {
            try
            {
                ...
                if (FileID != 0)
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Ticket_File_Folder_Devide_v2]", CommandType.StoredProcedure,
                           "@FileID", SqlDbType.Int, FileID,
