    ...
    public class TicketFile_ImportModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitializeCombo()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_EmployeeMarketing_LoadCombo]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostGetTeamplate(string type)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Import_GetTemplate]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteData(string sourceID ,string fileName ,int userMar)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Import_Info_Insert]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteDataItem(string data ,string source ,string importID ,int userMar, int isDuplicate)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dtResult = await connFunc.ExecuteDataTable("[MLU_sp_Ticket_Import_Insert]" ,CommandType.StoredProcedure ,
                        "@Created_By" ,SqlDbType.Int ,user.sys_userid ,
