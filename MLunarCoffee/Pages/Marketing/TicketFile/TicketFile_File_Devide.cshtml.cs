            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtTicket = await confunc.ExecuteDataTable("[YYY_sp_Ticket_Import_Last_Devide]", CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtGroup = await connFunc.ExecuteDataTable("[YYY_sp_Ticket_File_GroupTele_LoadCombo]", CommandType.StoredProcedure,
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtLevel = await connFunc.ExecuteDataTable("[YYY_sp_Ticket_File_TeleLevel_LoadCombo]", CommandType.StoredProcedure
                            , "@UserID", SqlDbType.Int, user.sys_userid);
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string ImportID)
        {
            try
            {
                ...
                if (ImportID != "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        await connFunc.ExecuteDataTable("YYY_sp_Ticket_Devide", CommandType.StoredProcedure,
