    ...
    public class TicketFile_File_MoveModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDataInitialize(string UserID, string ImportID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Ticket_File_Files_LoadData_Move]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string ImportID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dtFile = await connFunc.ExecuteDataTable("YYY_sp_Ticket_File_Files_Move_Insert_v2", CommandType.StoredProcedure,
