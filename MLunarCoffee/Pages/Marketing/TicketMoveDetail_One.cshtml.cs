    ...
    public class TicketMoveDetail_OneModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitializeCombo(int ticketid)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_LoadTeleMove]", CommandType.StoredProcedure,
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_GetStaffID]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string userTo, string reason, string ticketid)
        {
            ...
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Ticket_Move_Insert_One]", CommandType.StoredProcedure
