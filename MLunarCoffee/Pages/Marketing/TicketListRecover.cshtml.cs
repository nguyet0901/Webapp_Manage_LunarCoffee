    ...
    public class TicketListRecoverModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitializeCombo()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_LoadGroupTele]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadTicketList(string dateFrom, string dateTo, int groupTeleID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[YYY_sp_Ticket_TicketRecoverList_Load]", CommandType.StoredProcedure,
                  "@UserID", SqlDbType.Int, user.sys_userid
        ...
        public async Task<IActionResult> OnPostRecover(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_ticket_Recover]", CommandType.StoredProcedure,
