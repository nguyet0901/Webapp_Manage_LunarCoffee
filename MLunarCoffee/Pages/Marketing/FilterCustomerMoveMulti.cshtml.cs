    ...
    public class FilterCustomerMoveMultiModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInit()
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_TeleGroup_LoadCombo_ByUser]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadData(int groupId)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_Move_LoadTele_ByGroup]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecute(string dtcust)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_FilterCustomer_DivideMultiCustCare]" ,CommandType.StoredProcedure ,
