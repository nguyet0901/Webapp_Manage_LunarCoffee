    ...
    public class FilterTicketModel : PageModel
    {
            ...
            )
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Ticket_Filter]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadTeleSaleGroup(string GroupID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Ticket_Filter_GroupTeleSale_Load]" ,CommandType.StoredProcedure
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSource = await confunc.ExecuteDataTable("MLU_sp_Customer_Type_LoadList" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtGroupTele = await confunc.ExecuteDataTable("[MLU_sp_Ticket_TeleGroup_Load]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtStatus = await confunc.ExecuteDataTable("[MLU_sp_LoadCombo_Para_All]" ,CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtServiceCare = await confunc.ExecuteDataTable("[MLU_sp_ServiceCare_LoadCombo]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                    {
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            ...
                            dtStatusFollow = await confunc.ExecuteDataTable("[MLU_sp_Ticket_Combo_StatusFollowTele]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExcuteMoveTicket(string dataTicket ,string dataTele)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    await confunc.ExecuteDataTable("[MLU_sp_Ticket_Fiter_MoveTicket]" ,CommandType.StoredProcedure
