    ...
    public class listform : PageModel
    {
        ...
        public async Task<IActionResult> OnPostGetType()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_GetListType]" ,CommandType.StoredProcedure);
                }
                if (dt != null)
                {
        ...
        public async Task<IActionResult> OnPostGetTemplate(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_GetTemplate]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostChangeState(int id ,int status)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_ChangeState]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDelete(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_Delete]" ,CommandType.StoredProcedure
                        ,"@UserID" ,SqlDbType.Int ,user.sys_userid
                        ,"@templateid" ,SqlDbType.Int ,id
                   );
                }
        ...
        public async Task<IActionResult> OnPostClone(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_Clone]" ,CommandType.StoredProcedure
                        ,"@UserID" ,SqlDbType.Int ,user.sys_userid
                        ,"@templateid" ,SqlDbType.Int ,id
                   );
                }
        ...
        public async Task<IActionResult> OnPostImport(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_print_v2_ImportForm]" ,CommandType.StoredProcedure ,
