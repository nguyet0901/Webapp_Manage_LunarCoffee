            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Member_Load]" ,CommandType.StoredProcedure);
                        dt.TableName = "Member";
                        return dt;
                    }
                }));
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Branch_LoadLocation]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostSearchByOption(string data)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    {
                        ds=await confunc.ExecuteDataSet("[MLU_sp_Searching_List_By_Option]",CommandType.StoredProcedure
