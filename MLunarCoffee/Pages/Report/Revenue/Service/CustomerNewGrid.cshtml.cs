...
namespace MLunarCoffee.Pages.Report.RevenuePayment.Service
{
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string BranchID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Revenue_NewOld_Customer_Service]", CommandType.StoredProcedure,
