...
namespace MLunarCoffee.Pages.Report.Revenue.Customer
{
    public class GenderAndAgeBarModel : PageModel
    {
         ...
         public async Task<IActionResult>  OnPostLoadata(string dateFrom, string dateTo, string BranchID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Revenue_GenderAndAge]", CommandType.StoredProcedure,
