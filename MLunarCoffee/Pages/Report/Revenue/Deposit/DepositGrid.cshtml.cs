...
namespace SourceMain.Pages.Report.RevenuePayment.Deposit
{
    public class DepositGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string branchID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Customer_Deposit]", CommandType.StoredProcedure,
