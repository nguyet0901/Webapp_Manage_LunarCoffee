...
namespace SourceMain.Pages.Report.RevenuePayment.ServiceCat
{
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string BranchID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Revenue_NewOld_Customer_ServiceCat]", CommandType.StoredProcedure,
