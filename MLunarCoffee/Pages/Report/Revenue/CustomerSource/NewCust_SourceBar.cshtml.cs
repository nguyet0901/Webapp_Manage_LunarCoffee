...
namespace SourceMain.Pages.Report.RevenuePayment.CustomerSource
{
    public class NewCust_SourceBarModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string TokenBranch)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Revenue_Source_NewCustomer]", CommandType.StoredProcedure,
