...
namespace MLunarCoffee.Pages.Report.RevenuePayment.Lab
{
    public class LaboSupplierGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Revenue_Lab]", CommandType.StoredProcedure,
