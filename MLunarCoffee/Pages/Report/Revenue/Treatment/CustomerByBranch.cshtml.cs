...
namespace MLunarCoffee.Pages.Report.RevenuePayment.Treatment
{
    public class CustomerByBranchModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Customer_Treatment]", CommandType.StoredProcedure,
