    ...
    public class ReportProductRecieptModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSource = await confunc.ExecuteDataTable("MLU_sp_Supplier_LoadCombo", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string limit, string beginID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_rp_WareHouse_Product_Reciept]", CommandType.StoredProcedure
