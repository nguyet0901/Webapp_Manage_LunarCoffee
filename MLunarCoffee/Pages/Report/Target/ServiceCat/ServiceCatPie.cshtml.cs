...
namespace MLunarCoffee.Pages.Report.Target.ServiceCat
{
    public class ServiceCatPieModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_TargetByServiceCat]", CommandType.StoredProcedure,
