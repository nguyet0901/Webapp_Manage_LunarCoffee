...
namespace MLunarCoffee.Pages.Report.Target.CustomerSource
{
    public class SourceGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string tokenBranch)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Target_By_Source]", CommandType.StoredProcedure,
