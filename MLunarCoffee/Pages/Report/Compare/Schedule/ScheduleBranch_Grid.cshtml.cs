...
namespace MLunarCoffee.Pages.Report.Compare.Schedule
{
    public class ScheduleBranch_GridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string tokenBranch)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Compare_By_Scheduler]", CommandType.StoredProcedure,
