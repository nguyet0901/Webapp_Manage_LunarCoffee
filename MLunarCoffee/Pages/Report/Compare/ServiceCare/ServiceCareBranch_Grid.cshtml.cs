...
namespace MLunarCoffee.Pages.Report.Compare.ServiceCare
{
    public class ServiceCareBranch_GridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string tokenBranch)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Compare_By_Scheduler_And_ServiceCare]", CommandType.StoredProcedure,
