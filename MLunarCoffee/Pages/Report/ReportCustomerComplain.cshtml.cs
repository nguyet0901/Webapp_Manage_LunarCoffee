...
namespace SourceMain.Pages.Report
{
    public class ReportCustomerComplainModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string branchID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Customer_Complaint]", CommandType.StoredProcedure,
