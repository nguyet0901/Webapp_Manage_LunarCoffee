    ...
    public class ListReportShowDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoad_Initialize(string currentid)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Report_List_Show_LoadDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadComboMain()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_Report_Teamplate_Group_LoadCombo" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExcuteDataDetail(string ReportDetail ,string CurrentID)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Report_List_Show_Update]" ,CommandType.StoredProcedure ,
