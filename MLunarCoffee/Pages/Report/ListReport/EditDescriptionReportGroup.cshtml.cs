...
namespace MLunarCoffee.Pages.Report.ListReport
{
    public class EditDescriptionReportGroupModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("ZZZ_sp_EditDescriptionReportGroup_LoadDetail", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    DataTable dt = await connFunc.ExecuteDataTable("ZZZ_sp_EditDescriptionReportGroup_Update", CommandType.StoredProcedure,
