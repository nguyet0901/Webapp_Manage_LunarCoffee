    ...
    public class ListReportShowModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int currentID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_List_Show]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostExcuteData(string IsActive ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    DataTable dt = await connFunc.ExecuteDataTable("MLU_sp_EditDescriptionReportGroup_Active" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteDataDetail(string IsActive ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    DataTable dt = await connFunc.ExecuteDataTable("MLU_sp_EditDescriptionReport_Active" ,CommandType.StoredProcedure ,
                         "@IsActive" ,SqlDbType.NVarChar ,IsActive
                        ,"@CurrentID" ,SqlDbType.Int ,CurrentID
                        ,"@Modified_by" ,SqlDbType.Int ,user.sys_userid
