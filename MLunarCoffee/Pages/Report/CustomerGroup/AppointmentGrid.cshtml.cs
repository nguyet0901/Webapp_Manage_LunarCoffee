...
namespace MLunarCoffee.Pages.Report.CustomerGroup
{
    public class AppointmentGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Traffic_Customer_Group]", CommandType.StoredProcedure,
