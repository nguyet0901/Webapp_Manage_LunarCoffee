...
namespace MLunarCoffee.Pages.Report.Other
{
    public class TreatmentPlanStatusModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string BranchID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Customer_Tab_Treatment_Plan]", CommandType.StoredProcedure,
