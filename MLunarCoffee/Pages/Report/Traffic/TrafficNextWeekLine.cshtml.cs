...
namespace SourceMain.Pages.Report.Traffic
{
    public class TrafficNextWeekLineModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string tokenBranch)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_TrafficNextWeek]", CommandType.StoredProcedure);
