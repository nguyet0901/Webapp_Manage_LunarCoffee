...
namespace MLunarCoffee.Pages.Report.HistoryAdvice
{
    public class ReportCustomerHistoryAdviceGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string branchID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Customer_History_Advice]", CommandType.StoredProcedure,
