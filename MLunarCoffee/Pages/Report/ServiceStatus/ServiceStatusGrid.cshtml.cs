...
namespace MLunarCoffee.Pages.Report.ServiceStatus
{
    public class ServiceStatusGrid : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string BranchID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_rp_ServiceStatus]", CommandType.StoredProcedure,
