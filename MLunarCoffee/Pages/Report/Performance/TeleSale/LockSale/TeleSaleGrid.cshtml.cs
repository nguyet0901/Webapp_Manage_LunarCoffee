...
namespace SourceMain.Pages.Report.Performance.TeleSale.LockSale
{
         ...
         public async Task<IActionResult> OnPostLoadata(string dateFrom, string dateTo, string branchid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[ZZZ_sp_Report_Sale_Performance]", CommandType.StoredProcedure
