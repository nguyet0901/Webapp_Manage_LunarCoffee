...
{
    public class InboxNewByTagBarModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            if (String.IsNullOrEmpty(Request.Query["TokenPage"]))
            {
                _TokenPage = "0";
            }
            else
         ...
         public async Task<IActionResult> OnPostLoadata(string TokenPage, string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("[ZZZ_sp_Report_PageFacebook_Tag]", CommandType.StoredProcedure,
