...
namespace MLunarCoffee.Pages.Report.Dashboard
{
    public class CustomerTrafficBySourceGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Dashboard_CustomerTrafficBySource]", CommandType.StoredProcedure,
