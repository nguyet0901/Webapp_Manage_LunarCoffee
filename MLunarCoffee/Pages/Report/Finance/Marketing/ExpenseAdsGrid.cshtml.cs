...
namespace MLunarCoffee.Pages.Report.Finance.Marketing
{
    public class ExpenseAdsGridModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int branchID, string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Report_Marketing_Performance_Ads]", CommandType.StoredProcedure,
