...
namespace MLunarCoffee.Pages.Report.ReportSheet
{
    public class ReportSheetDescriptionDetailModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt =await  confunc.ExecuteDataTable("MLU_sp_ReportSheet_LoadDetail", CommandType.StoredProcedure,
            ...
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    if (Type == 0)
                    {
                        ...
                        DataTable dt =await connFunc.ExecuteDataTable("MLU_sp_ReportSheet_Description_Update", CommandType.StoredProcedure,
                    ...
                    {
                        DataTable dt =await connFunc.ExecuteDataTable("MLU_sp_ReportSheet_Description_Code_Update", CommandType.StoredProcedure,
