    ...
    public class ReportTreatmentMesureModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("[MLU_sp_MeasureType_LoadComboAll]", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_MeasureContent_LoadCombo]", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoaddata(string branchID, string dateFrom, string dateTo, int measureType, int measureContent, int valDiffFrom, int valDiffTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_rp_MeasureCustomer]", CommandType.StoredProcedure
