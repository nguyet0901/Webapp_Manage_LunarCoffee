    ...
    public class HRComboTypeDetailModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadInitializeData(string id)
        {
            try { 
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("[YYY_sp_HR_ComboType_LoadTypeParent]", CommandType.StoredProcedure
         ...
         public async Task<IActionResult> OnPostLoadata(int id)
        {
            try { 
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt =await  confunc.ExecuteDataTable("YYY_sp_HR_ComboType_LoadDetail", CommandType.StoredProcedure,
