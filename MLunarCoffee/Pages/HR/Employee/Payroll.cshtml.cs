    ...
    public class PayrollModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboMain()
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Work_Scheduler_Employee_Group_LoadList]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Revenue_Payroll]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadDataPayroll(string dateFrom ,string dateTo ,int branch ,int group)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Payroll_Load]" ,CommandType.StoredProcedure ,
