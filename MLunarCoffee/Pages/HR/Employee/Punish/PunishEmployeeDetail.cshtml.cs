         ...
         public async Task<IActionResult> OnPostLoadInitialize(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt =await  confunc.ExecuteDataTable("YYY_sp_User_Employee_LoadCombo", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt =await  confunc.ExecuteDataTable("YYY_sp_HR_Combo_Type_LoadType", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt =await  confunc.ExecuteDataTable("YYY_sp_HR_Employee_Punish_LoadDetail", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        await connFunc.ExecuteDataTable("YYY_sp_Employee_Punish_Insert", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        await connFunc.ExecuteDataTable("YYY_sp_Employee_Punish_Update", CommandType.StoredProcedure,
