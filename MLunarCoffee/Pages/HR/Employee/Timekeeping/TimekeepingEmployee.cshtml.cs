    ...
    public class TimekeepingEmployeeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInit()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dtEmployee = await confunc.ExecuteDataTable("[MLU_sp_Timekeeping_Employee]",
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dtGroupEmployee = await confunc.ExecuteDataTable("[MLU_sp_Work_Scheduler_Employee_Group_LoadList]",
                        CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadData(string dateFrom, string dateTo)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Timekeeping_Load]", CommandType.StoredProcedure
