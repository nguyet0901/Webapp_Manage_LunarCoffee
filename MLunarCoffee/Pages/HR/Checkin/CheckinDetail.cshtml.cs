    ...
    public class CheckinDetail : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_HR_CheckIn_LoadDataDetail]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_HR_CheckIn_Update_v2]" ,CommandType.StoredProcedure ,
