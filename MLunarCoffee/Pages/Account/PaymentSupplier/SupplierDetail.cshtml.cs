    ...
    public class SupplierDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadForm(int supid, int beginID, string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Account_SupplierForm]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDeleteDeposit(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Supplier_Deposit_Delete]", CommandType.StoredProcedure,
