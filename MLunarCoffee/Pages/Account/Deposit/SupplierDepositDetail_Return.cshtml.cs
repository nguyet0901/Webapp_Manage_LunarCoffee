    ...
    public class SupplierDepositDetail_ReturnModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadInitialize(string SupplierID)
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Supplier_LoadCombo]", CommandType.StoredProcedure);
                ...
                {
                    DataTable dt = new DataTable();
                    dt = await confunc.ExecuteDataTable("MLU_sp_Supplier_MaxDeposit_Return", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_Supplier_Deposit_Insert", CommandType.StoredProcedure
