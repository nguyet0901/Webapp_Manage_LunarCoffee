    ...
    public class ClosingEntryLock : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadLock(string date ,int branchid)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Closing_Entry_LockLoad]" ,CommandType.StoredProcedure ,
            ...
            ,string amountTotal ,string sign)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Closing_Entry_Insert]" ,CommandType.StoredProcedure ,
