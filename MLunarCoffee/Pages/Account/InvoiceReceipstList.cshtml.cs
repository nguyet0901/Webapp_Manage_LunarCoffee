...
namespace MLunarCoffee.Pages.Account
{
    public class InvoiceReceipstListModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadataAccount(string date, int branchid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                ds = await confunc.ExecuteDataSet("[MLU_sp_Account_Receipts_LoadList]", CommandType.StoredProcedure,
                  "@UserID", SqlDbType.Int, user.sys_userid
         ...
         public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Account_Delete]", CommandType.StoredProcedure,
