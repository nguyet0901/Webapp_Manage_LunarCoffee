    ...
    public class ClosingShiftLockModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitilize(int branchid)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Closing_Shift_LoadInit]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadLock(string date ,int branchid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Closing_Shift_LockLoad]" ,CommandType.StoredProcedure ,
            ...
            ,string amountTotal ,string sign)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Closing_Shift_Insert]" ,CommandType.StoredProcedure ,
