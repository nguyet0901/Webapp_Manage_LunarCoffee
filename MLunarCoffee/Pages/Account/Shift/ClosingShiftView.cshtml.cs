    ...
    public class ClosingShiftViewModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitialize(string currentID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Closing_Shift_View_Load]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int ID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Closing_Shift_History_Delete]", CommandType.StoredProcedure,
