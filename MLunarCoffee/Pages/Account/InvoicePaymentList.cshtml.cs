...
{
    public class InvoicePaymentListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadComboInitialize()
        {
            try
            {
                ...
                {
                    dt =await connFunc.ExecuteDataTable("[MLU_sp_Account_Reason]", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadataAccount(string date, int branchid)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                ds =await confunc.ExecuteDataSet("[MLU_sp_Account_Payment_LoadList]", CommandType.StoredProcedure,
                  "@UserID", SqlDbType.Int, user.sys_userid,
