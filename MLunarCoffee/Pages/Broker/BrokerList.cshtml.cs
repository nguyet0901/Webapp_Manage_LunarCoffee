    ...
    public class BrokerListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadList(int dateType ,int limit ,int beginID ,string dateFrom ,string dateTo ,int brokerID ,int isSearchAll ,string textSearch)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Broker_LoadList_V2]" ,CommandType.StoredProcedure
                ...
                var tasks = new List<Task<DataTable>>
                {
                    Task.Run(async () =>
                    {
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            ...
                            dtInfo = await confunc.ExecuteDataTable("[MLU_sp_Broker_LoadDetail_Info]" ,CommandType.StoredProcedure
                              ,"@BrokerID" ,SqlDbType.Int ,BrokerID);
                    ...
                    Task.Run(async () =>
                    {
                        ...
                        {
                            DataTable dt = new DataTable();
                            dt = await confunc.ExecuteDataTable("[MLU_sp_Broker_LoadDetail]" ,CommandType.StoredProcedure
                              ,"@BrokerID" ,SqlDbType.Int ,BrokerID
                    ...
                    Task.Run(async () =>
                    {
                        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                        {
                            ...
                            dtPDetail = await confunc.ExecuteDataTable("[MLU_sp_Broker_LoadPayDetail]" ,CommandType.StoredProcedure
                              ,"@BrokerID" ,SqlDbType.Int ,BrokerID);
        ...
        public async Task<IActionResult> OnPostLoadPoint(int brokerID ,int custID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Broker_LoadDetail_Point]" ,CommandType.StoredProcedure
                      ,"@BrokerID" ,SqlDbType.Int ,brokerID
        ...
        public async Task<IActionResult> OnPostDeleteItemBroker(int id ,int type)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Customer_PaymentBroker_Delete]" ,CommandType.StoredProcedure ,
