    ...
    public class ServiceCardListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(int id, int limit, int beginID)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Setting_Service_Card_LoadList]", CommandType.StoredProcedure
                            , "@id", SqlDbType.Int, id
        ...
        public async Task<IActionResult> OnPostDisableItem(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_ServiceCard_Disable]", CommandType.StoredProcedure,
