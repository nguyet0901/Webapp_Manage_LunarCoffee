...
namespace SourceMain.Pages.Dash.Revenue.CashOther
{
    ...
    public class CashOtherManagementModel : PageModel {
        public void OnGet ( ) {
         ...
         public async Task<IActionResult> OnPostLoadata ( ) {
            try {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase ()) {
                    ...
                    ds = await confunc.ExecuteDataSet ("[YYY_sp_Dash_Revenues_Expenditures_Management]", CommandType.StoredProcedure,
