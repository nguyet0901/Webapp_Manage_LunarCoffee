    ...
    public class BranchDetailModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtBranch = await confunc.ExecuteDataTable("YYY_sp_LoadCombo_Area" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("YYY_sp_LoadCombo_Bank" ,CommandType.StoredProcedure);
                        dt.TableName = "Bank";
                        return dt;
                    }
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dtBranch = new DataTable();
                        dtBranch = await confunc.ExecuteDataTable("[YYY_sp_BranchMailServer]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Branch_LoadDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string CurrentID ,string ImageDelete)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Branch_Insert]" ,CommandType.StoredProcedure ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_Branch_Update]" ,CommandType.StoredProcedure ,
                            "@BranchCode" ,SqlDbType.NVarChar ,DataMain.BranchCode.Replace("'" ,"").Trim() ,
                            "@Name " ,SqlDbType.NVarChar ,DataMain.Name.Replace("'" ,"").Trim() ,
                            "@ShortName " ,SqlDbType.NVarChar ,DataMain.ShortName.Replace("'" ,"").Trim() ,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Branch_Delete]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,CurrentID ,
        ...
        public async Task<IActionResult> OnPostCheckPassword(string password)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_User_CheckPassword]" ,CommandType.StoredProcedure ,
                        "@UserID" ,SqlDbType.Int ,user.sys_userid
                    );
                }
