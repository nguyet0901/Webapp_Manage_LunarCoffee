    ...
    public class ContractTypeListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_EmployeeContractType_Load]" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostDelete(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_EmployeeContractType_Delete]" ,CommandType.StoredProcedure
