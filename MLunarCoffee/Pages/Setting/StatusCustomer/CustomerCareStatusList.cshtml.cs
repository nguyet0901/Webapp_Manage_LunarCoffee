...
namespace MLunarCoffee.Pages.Setting.StatusCustomer
{
    public class CustomerCareStatusListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadataStatus(int TypeStatusID)
        {
            ...
            {
                ds = await confunc.ExecuteDataSet("YYY_sp_Setting_CustomerCareStatus_LoadList", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadataQuickNote(int TypeStatusID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("YYY_sp_Setting_CustomerCare_QuickTemplate_LoadList", CommandType.StoredProcedure,
                  "@TypeID", SqlDbType.Int, TypeStatusID);
            }
            if (dt != null)
            {
        ...
        public async Task<IActionResult> OnPostDeleteItem(string StatusID)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Setting_CustomerCareStatus_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItemTemplate(string TemplateID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Setting_CustomerCare_QuickTemplate_Delete]", CommandType.StoredProcedure,
