    ...
    public class AccountEntryListModel : PageModel
    {
        public async Task<IActionResult> OnPostInit()
        {
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("YYY_sp_LoadCombo_Para_Method" ,CommandType.StoredProcedure
                        );
                        dt.TableName = "method";
                        return dt;
                    }
        ...
        public async Task<IActionResult> OnPostLoadData(int currentAcc)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Setting_AccountEntry_LoadList]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDelete(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_AccountEntry_Delete]" ,CommandType.StoredProcedure ,
