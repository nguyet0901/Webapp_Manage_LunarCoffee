    ...
    public class TreatmentStageListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_TreatmentStage_Load]" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_TreatmentStage_Delete]" ,CommandType.StoredProcedure ,
