    ...
    public class RevenueSettingModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Setting_Revenue]", CommandType.StoredProcedure);
                }
                if (dt != null)
                {
        ...
        public async Task<IActionResult> OnPostExcuteData(string data)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_RevenueSetting_Update", CommandType.StoredProcedure,
