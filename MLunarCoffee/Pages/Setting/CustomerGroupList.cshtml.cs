    ...
    public class CustomerGroupListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadataCustomerGroup()
        {
            try
            {
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt=await confunc.ExecuteDataTable("[MLU_sp_Customer_Group_LoadList]",CommandType.StoredProcedure);
                    dt.TableName="Group";
                    ds.Tables.Add(dt);
                }
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Customer_Group_Delete]",CommandType.StoredProcedure,
