...
namespace MLunarCoffee.Pages.Setting.Teeth
{
    public class TeethDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_Setting_Teeth_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string AdultTeeth, string BabyTeeth, string CurrentID)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[MLU_sp_Setting_Teeth_Update]", CommandType.StoredProcedure,
