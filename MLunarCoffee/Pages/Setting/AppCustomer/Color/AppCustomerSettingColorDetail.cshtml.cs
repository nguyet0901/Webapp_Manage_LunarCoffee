    ...
    public class AppCustomerSettingColorDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDetail(int CurrentID)
        {
            try
            {
                ...
                {
                    ds = await conFunc.ExecuteDataSet("[MLU_sp_AC_ColorCollect_LoadDetail]", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostExcuteData(string data)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_AC_ColorCollect_Update]", CommandType.StoredProcedure
