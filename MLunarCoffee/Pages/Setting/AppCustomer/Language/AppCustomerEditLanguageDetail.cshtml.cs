    ...
    public class AppCustomerEditLanguageDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDetail(int CurrentID, int Type)
        {
            try
            {
                ...
                {
                    dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_IniLanguage_LoadDetail]", CommandType.StoredProcedure
            ...
            try
            {
                ...
                switch (Type)
                {
                    case 1:
                        using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                        {
                            dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_IniLanguage_UpdateIcon]", CommandType.StoredProcedure
                    ...
                    case 2:
                        using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                        {
                            dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_IniLanguage_UpdateButton]", CommandType.StoredProcedure
                                , "@textEN", SqlDbType.NVarChar, dataMain.TextEN
                                , "@textVi", SqlDbType.NVarChar, dataMain.TextVN
                                , "@Description", SqlDbType.NVarChar, dataMain.Description
                                , "@CurrentID", SqlDbType.Int, CurrentID
                    ...
                    case 3:
                        using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                        {
                            dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_IniLanguage_UpdateLabel]", CommandType.StoredProcedure
                                , "@textEN", SqlDbType.NVarChar, dataMain.TextEN
                                , "@textVi", SqlDbType.NVarChar, dataMain.TextVN
                                , "@Description", SqlDbType.NVarChar, dataMain.Description
                                , "@CurrentID", SqlDbType.Int, CurrentID
