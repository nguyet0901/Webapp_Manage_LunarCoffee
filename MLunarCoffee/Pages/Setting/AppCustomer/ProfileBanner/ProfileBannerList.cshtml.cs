    ...
    public class ProfileBannerListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadList(int ID)
        {
            try
            {
                ...
                {
                    dt = await conFunc.ExecuteDataTable("[YYY_sp_AC_ProfileBanner_Load]" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostHide(int ID, int IsDelete, int IsHide)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                {
                    dt = await conFunc.ExecuteDataTable("[YYY_sp_AC_ProfileBanner_ExecutedHide]" ,CommandType.StoredProcedure
