    ...
    public class AppCustomerSettingDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadCombo()
        {
            try
            {
                ...
                {
                    dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_ColorCollect_Load]", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostLoadData(int ID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                {
                    dt = await conFunc.ExecuteDataTable("[MLU_sp_IniSetting_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExecuted(string data, int CurrentID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_IniSetting_Update]", CommandType.StoredProcedure
