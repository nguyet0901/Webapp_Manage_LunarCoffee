    ...
    public class SettingAppModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadList()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_Setting_AC_TypeAccept", CommandType.StoredProcedure);
                    dt.TableName = "TypeAccept";
                    ds.Tables.Add(dt);
                }
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_Setting_AC_IniSetting", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostApplyVer(string data)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_AC_IniSetting_Apply]", CommandType.StoredProcedure
