    ...
    public class SettingIconListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_Color_Load]" ,CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostExecuted(string CurrentID, string State)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase conFunc = new Models.ExecuteDataBase())
                {
                    dt = await conFunc.ExecuteDataTable("[MLU_sp_AC_Color_Update]" ,CommandType.StoredProcedure
