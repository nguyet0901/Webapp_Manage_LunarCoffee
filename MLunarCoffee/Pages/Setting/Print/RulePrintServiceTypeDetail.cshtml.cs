    ...
    public class RulePrintServiceTypeDetailModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        SerType = await confunc.ExecuteDataTable("MLU_sp_v2_ServiceType_LoadCombo", CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        StogeRule = await confunc.ExecuteDataTable("MLU_sp_StogeRule_LoadCombo", CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadDetail(int ID)
        {
            ...
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_RulePrintServiceType_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExecuted(string SerTypeID, string StoreRule)
        {
            try
            {
                ...
                if (SerTypeID != "0")
                {
                    ...
                    {
                        await connFunc.ExecuteDataTable("MLU_sp_RulePrintServiceType_Update", CommandType.StoredProcedure
