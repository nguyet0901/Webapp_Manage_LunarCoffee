    ...
    public class CustomerInfoLayoutModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    ds = await connFunc.ExecuteDataSet("[YYY_sp_Setting_CustomerInfoLayout_Load]", CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostExcuteData(string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_CustomerInfoLayout_Update]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteDataChild(string CurrentID,string value)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_CustomerInfoLayoutChild_Update]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.NVarChar ,CurrentID ,
