    ...
    public class QRListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_SysQR_LoadList]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostUpdate(int currentID ,string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Setting_SysQR_Update]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostImport(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_SysQR_Import]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostDelete(string code ,string id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_SysQR_Delete]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostClone(string id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_SysQR_Clone]" ,CommandType.StoredProcedure ,
                        "@ID" ,SqlDbType.Int ,Convert.ToInt32(id) ,
                        "@userID" ,SqlDbType.Int ,user.sys_userid
                    );
                }
