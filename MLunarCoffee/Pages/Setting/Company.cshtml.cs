    ...
    public class CompanyModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    dt=await connFunc.ExecuteDataTable("[YYY_sp_CompanyLoad]",CommandType.StoredProcedure);
                }
        ...
        public async Task<IActionResult> OnPostExcuteCompany(string data)
        {
            ...
            try
            {
                ...
                using(Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_Company_Update]",CommandType.StoredProcedure,
