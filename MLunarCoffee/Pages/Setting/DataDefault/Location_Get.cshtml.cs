    ...
    public class Location_GetModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Setting_Location_LoadList]" ,CommandType.StoredProcedure);
                }
                if (ds != null)
                {
        ...
        public async Task<IActionResult> OnPostExcuteData(string data,string type)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Setting_Location_Update]" ,CommandType.StoredProcedure ,
