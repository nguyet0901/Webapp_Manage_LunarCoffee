    ...
    public class DiseaseSignDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Setting_DiseaseSign_LoadDetailContent]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string content, string CurrentID)
        {
            try
            {
                ...
                {
                    DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_DiseaseSign_UpdateContent]", CommandType.StoredProcedure,
