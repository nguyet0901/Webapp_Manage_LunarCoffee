    ...
    public class DiseaseTemplateModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("[MLU_sp_Setting_Diagnose_Template]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostUpdate(int currentID ,string data)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[MLU_sp_Setting_Diagnose_Template_Update]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostImport(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Setting_Diagnose_Template_ImportV2]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostDelete(string code)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Setting_Diagnose_Template_Delete]" ,CommandType.StoredProcedure ,
