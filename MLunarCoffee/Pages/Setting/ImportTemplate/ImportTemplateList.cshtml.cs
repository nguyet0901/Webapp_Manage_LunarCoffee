    ...
    public class ImportTemplateListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData(string type)
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Setting_Import_Template_LoadList]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDisableItem(int id, int isRequired)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_Import_Template_Disable]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Setting_Template_Update]" ,CommandType.StoredProcedure 
