    ...
    public class CustomerMembershipList : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt = await confunc.ExecuteDataTable("[YYY_sp_CustomerMembership_LoadList]", CommandType.StoredProcedure);
                    dt.TableName = "Group";
                    ds.Tables.Add(dt);
                }
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_CustomerMembership_Delete]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostCloneItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    await connFunc.ExecuteDataTable("[YYY_sp_CustomerMembership_Clone]", CommandType.StoredProcedure,
                        "@CurrentID", SqlDbType.Int, id,
                        "@Datenow", SqlDbType.DateTime, Comon.Comon.GetDateTimeNow(),
                        "@UserID", SqlDbType.Int, user.sys_userid
                    );
        ...
        public async Task<IActionResult> OnPostDisableItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_CustomerMembership_Disable]" ,CommandType.StoredProcedure ,
                        "@CurrentID" ,SqlDbType.Int ,id ,
                        "@UserID" ,SqlDbType.Int ,user.sys_userid
                    );
                }
