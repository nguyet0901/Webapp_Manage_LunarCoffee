    ...
    public class ExchangeRateDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadata(int id)
        {
            ...
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ExchangeRate_LoadDetail]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID != "0")
                {
                    ...
                    {
                        DataTable dt = await connFunc.ExecuteDataTable("[YYY_sp_ExchangeRate_Update]", CommandType.StoredProcedure,
