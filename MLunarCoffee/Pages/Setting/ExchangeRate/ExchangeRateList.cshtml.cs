...
namespace MLunarCoffee.Pages.Setting.ExchangeRate
{
    public class ExchangeRateListModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadData()
        {
            ...
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_ExchangeRate_LoadList]", CommandType.StoredProcedure);
            }
            if (dt != null)
            {
        ...
        public async Task<IActionResult> OnPostLoadHistory(int exchangeRateID)
        {
            ...
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = await confunc.ExecuteDataTable("[MLU_sp_ExchangeRate_LoadHistory]", CommandType.StoredProcedure
