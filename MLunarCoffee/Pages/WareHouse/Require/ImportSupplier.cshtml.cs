    ...
    public class ImportSupplier : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitialize(int DetailID)
        {
            try
            {
                ...
                {
                    ds=await confunc.ExecuteDataSet("MLU_sp_WareHouse_ImportSup_Info", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostUnImport(int DetailID)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt=await confunc.ExecuteDataTable("[MLU_sp_WareHouse_Export_UnImportSup]",CommandType.StoredProcedure
