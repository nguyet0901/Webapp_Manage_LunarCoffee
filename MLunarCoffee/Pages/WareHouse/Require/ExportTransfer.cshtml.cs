    ...
    public class ExportTransferModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostGetInfo(int DetailID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_WareHouse_ExportTransfer_Info", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string DateExecute, string IsPackageNumber, string CurrentID, string IntAmount)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("YYY_sp_WareHouse_ExportTransfer_ImportWare", CommandType.StoredProcedure
                        , "@DateExecute", SqlDbType.DateTime, Comon.Comon.DateTimeDMY_To_YMDHHMM(DateExecute)
        ...
        public async Task<IActionResult> OnPostUpdateSign(int id, string sign)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_WareHouse_SignExportOrder]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Product_ExportWare_Delete]", CommandType.StoredProcedure,
