    ...
    public class SupplierListModel : PageModel
    {
        ...
        public  async Task<IActionResult> OnPostLoadDataSupplier()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_Product_Supplier_LoadList", CommandType.StoredProcedure,
        ...
        public  async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Product_Supplier_Delete]", CommandType.StoredProcedure,
