    ...
    public class NormSettingDetailModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadUpdate(int id)
        {
            try
            {
                ...
                {
                    dt =await  confunc.ExecuteDataTable("[MLU_sp_Product_Norm_LoadDetail]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        DataTable dt =await connFunc.ExecuteDataTable("[MLU_sp_Product_Norm_Update]", CommandType.StoredProcedure,
