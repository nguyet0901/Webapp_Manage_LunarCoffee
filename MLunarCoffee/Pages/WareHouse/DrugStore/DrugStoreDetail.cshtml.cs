    ...
    public class DrugStoreDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostGetWareHouse(int MedID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("MLU_sp_WareHouse_DrugStore_Info" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostUnExport(int DetailID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("MLU_sp_Drug_Export_UnExportBranch" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadPackNum(string MasterID, string ProductID, string WareID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_DrugStore_PackageNumer]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string ware ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("MLU_sp_WareHouse_Export_DrugExecute" ,CommandType.StoredProcedure ,
