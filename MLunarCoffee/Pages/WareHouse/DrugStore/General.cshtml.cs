    ...
    public class GeneralModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtProduct = await connFunc.ExecuteDataTable("[YYY_sp_DrugStore_Product_Get]" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadData(string detailID ,string dateFrom ,string dateTo ,string beginID ,string limit ,string medCode)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_WareHouse_DrugStore_LoadListv2]" ,CommandType.StoredProcedure
