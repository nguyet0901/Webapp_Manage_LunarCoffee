    ...
    public class ExportDetail : PageModel
    {
        ...
        public async Task<IActionResult> OnPostGetWareHouse(int DetailID)
        {
            try
            {
                ...
                {
                    ds = await confunc.ExecuteDataSet("YYY_sp_WareHouse_ExportByBranch_Info" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadPackNum(string ProductID)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Product_PackageNumer]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostUnExport(int DetailID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_WareHouse_Export_UnExportBranch]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostDelete(int DetailID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_WareHouse_Export_DeleteExportBranch]" ,CommandType.StoredProcedure
                         ,"@MasterID" ,SqlDbType.Int ,DetailID);
                }
                if (dt != null)
                {
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string ware ,string DateExecute ,string IsPackageNumber ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("YYY_sp_WareHouse_Export_PrepareExecute" ,CommandType.StoredProcedure ,
