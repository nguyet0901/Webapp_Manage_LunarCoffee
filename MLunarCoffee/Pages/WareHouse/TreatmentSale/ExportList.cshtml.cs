    ...
    public class ExportList : PageModel
    {
            ...
            , string idbegin, string limit)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_WareHouse_ExportByBranch]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostUpdateSign(int id, string sign, string typeid)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_WareHouse_Export_Update_Sign]", CommandType.StoredProcedure,
