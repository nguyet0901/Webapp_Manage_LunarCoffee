    ...
    public class StockList  : PageModel
    {
            ...
            ,string beginex, string beginexts, string beginim,string limit)
        {
            try
            {
                ...
                {
                    ds=await confunc.ExecuteDataSet("[YYY_sp_WareHouse_StockList]",CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostUpdateSign(int id,string sign,string typeid)
        {
            try
            {
                ...
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_Product_Stock_Update_Sign]",CommandType.StoredProcedure,
