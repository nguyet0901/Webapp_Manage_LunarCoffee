        ...
        public async Task<IActionResult> OnPostLoadData(string WareID)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dt=await confunc.ExecuteDataTable("[YYY_sp_v2_WareHouse_ProductStatus]",CommandType.StoredProcedure
                ...
                using(Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ...
                    dse=await confunc.ExecuteDataSet("[YYY_sp_v2_WareHouse_ProductExpired]",CommandType.StoredProcedure
                        ,"@WareID",SqlDbType.Int,WareID);
                    DataTable dt = new DataTable();
