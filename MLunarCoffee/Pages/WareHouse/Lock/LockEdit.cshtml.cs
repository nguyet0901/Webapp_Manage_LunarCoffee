    ...
    public class LockEdit : PageModel
    {
        ...
        public async Task<IActionResult> OnPostInitialize(string LockID)
        {
            try
            {
                ...
                {
                    dt =await connFunc.ExecuteDataTable("[YYY_sp_v2_WareHouse_Lock_EditInfo]", CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostLoadData(string LockID)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt=await connFunc.ExecuteDataTable("[YYY_sp_v2_WareHouse_Norm_Current]",CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExcuteData(string data,  string LockID)
        {
            try
            {
                ...
                using(Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt=await connFunc.ExecuteDataTable("[YYY_sp_v2_WareHouse_Norm_Lock_Update]",CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt =await connFunc.ExecuteDataTable("[YYY_sp_v2_WareHouse_Norm_Lock_Delete]", CommandType.StoredProcedure,
