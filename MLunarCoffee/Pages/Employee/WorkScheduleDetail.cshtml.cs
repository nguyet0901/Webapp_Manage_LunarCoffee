        ...
        public async Task<IActionResult> OnPostLoadDataDetail(string empid, string datecurrent)
        {
            ...
            if (datecurrent != "0")
            {
                ...
                { 
                    ...
                    ds = await confunc.ExecuteDataSet("[MLU_sp_Work_Schedule_LoadExtention]"
            ...
            { 
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Work_Schedule_LoadUpdate]", CommandType.StoredProcedure,
                      "@EmpID", SqlDbType.Int, Convert.ToInt32(empid));
                }
        ...
        public async Task<IActionResult> OnPostExcuteData(string data, string empid, string date, string datecurrent)
        {
            try
            {
                ...
                if (datecurrent != "0")
                {
                    ...
                    {
                       dt= await connFunc.ExecuteDataTable("MLU_sp_Work_Schedule_Extension_Update", CommandType.StoredProcedure,
                ...
                else
                {
                    ...
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt= await connFunc.ExecuteDataTable("MLU_sp_Work_Schedule_Update", CommandType.StoredProcedure,
                            "@EmpID", SqlDbType.NVarChar, empid,
