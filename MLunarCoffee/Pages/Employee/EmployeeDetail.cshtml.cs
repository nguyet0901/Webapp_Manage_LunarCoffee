    ...
    public class EmployeeDetailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadDetail(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    ds = await confunc.ExecuteDataSet("[YYY_sp_Employee_LoadDetail]" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostLoadComboMain()
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("YYY_sp_Employee_LoadCombo_Group" ,CommandType.StoredProcedure);
                ds.Tables.Add(dt);
            }
            ...
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("[YYY_sp_Employee_Level_LoadCombo]" ,CommandType.StoredProcedure);
                ds.Tables.Add(dt);
            }
            //LoadContract
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("[YYY_sp_Employee_Contract_LoadCombo]" ,CommandType.StoredProcedure);
                ds.Tables.Add(dt);
            }
            //Syntax
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                DataTable dt = new DataTable();
                dt = await confunc.ExecuteDataTable("[YYY_sp_Employee_Syntax_Load]" ,CommandType.StoredProcedure);
                ds.Tables.Add(dt);
            }
            return Content(Comon.DataJson.Dataset(ds));
        }
        ...
        public async Task<IActionResult> OnPostExcuteData(string data ,string CurrentID ,string type ,string dataAllowrance)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Employee_Insert" ,CommandType.StoredProcedure ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("YYY_sp_Employee_Update" ,CommandType.StoredProcedure ,
                            "@Email" ,SqlDbType.NVarChar ,DataMain.Email1.Replace("'" ,"").Trim() ,
                            "@Nickname" ,SqlDbType.NVarChar ,DataMain.Nickname.Replace("'" ,"").Trim() ,
                            "@Address" ,SqlDbType.NVarChar ,DataMain.Address.Replace("'" ,"").Trim() ,
                            "@Phone" ,SqlDbType.NVarChar ,DataMain.Phone1.Replace("'" ,"").Trim() ,
