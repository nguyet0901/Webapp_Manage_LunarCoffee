    ...
    public class FanpageDetailModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadata(int id)
        {
            try
            {
                ...
                {
                    dt =await  confunc.ExecuteDataTable("[MLU_sp_Ticket_PageFacebook_LoadDetails]", CommandType.StoredProcedure,
         ...
         public async Task<IActionResult> OnPostInitialize()
        {
            try
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt =await connFunc.ExecuteDataTable("[MLU_sp_PageFacebookUser_UsernameCombo]", CommandType.StoredProcedure);
         ...
         public async Task<IActionResult> OnPostExcuteData(string data, string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        DataTable dt =await connFunc.ExecuteDataTable("[MLU_sp_Ticket_PageFacebook_Insert]", CommandType.StoredProcedure,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        DataTable dt =await connFunc.ExecuteDataTable("[MLU_sp_Ticket_PageFacebook_Update]", CommandType.StoredProcedure,
