    ...
    public class MessengerStoreModel : PageModel
    {
         ...
         public async Task<IActionResult> OnPostLoadInitializeData(string PageID, string Date)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt2 =await  confunc.ExecuteDataTable("[MLU_sp_Messenger_No_Telesale]", CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecute (string data)
        {
            try
            {
                ...
                //    result =await  confunc.ExecuteDataTable("[MLU_sp_Messenger_Store_Insert]", CommandType.StoredProcedure,
