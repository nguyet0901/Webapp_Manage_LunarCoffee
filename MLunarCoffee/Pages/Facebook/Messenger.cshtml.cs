...
namespace SourceMain.Pages.Facebook
{
    public class MessengerModel : PageModel
    {
        ...
        //        {
        //            ds = await confunc.ExecuteDataSet("[YYY_sp_Facebook_v2_Initialize]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_LoadConversation]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Area]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Servicecare]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Dicount]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Tag]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Staff]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Load_Note]", CommandType.StoredProcedure
        //             , "@userid", SqlDbType.Int, user.sys_userid
        //             , "@page", SqlDbType.NVarChar, page
        //             , "@client", SqlDbType.NVarChar, client);
        //        }
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Load_Time]", CommandType.StoredProcedure
        //               , "@userid", SqlDbType.Int, user.sys_userid
        //               , "@page", SqlDbType.NVarChar, page
        //               , "@client", SqlDbType.NVarChar, client);
        //        }
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_Note]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Save_CallBackTime]", CommandType.StoredProcedure,
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Load_TicketInfo]", CommandType.StoredProcedure
        //             , "@page", SqlDbType.NVarChar, page
        //             , "@client", SqlDbType.NVarChar, client);
        //        }
        //        return Content(JsonConvert.SerializeObject(dt));
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Load_Specific_Conver]", CommandType.StoredProcedure
        //             , "@page", SqlDbType.NVarChar, page
        //             , "@client", SqlDbType.NVarChar, client);
        //        }
        //        return Content(JsonConvert.SerializeObject(dt));
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Load_Specific_Comment]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Make_Read_To_Unread]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Make_UnRead_To_Read]", CommandType.StoredProcedure
        //            , "@type", SqlDbType.NVarChar, type.ToLower()
        //            , "@page", SqlDbType.NVarChar, page
        //             , "@comment", SqlDbType.NVarChar, comment
        //            , "@client", SqlDbType.NVarChar, client
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt =await  confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Make_Star_NonStar]", CommandType.StoredProcedure
        //            , "@page", SqlDbType.NVarChar, page
        //            , "@client", SqlDbType.NVarChar, client);
        //        }
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Update_When_Send_Comment]", CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataTable("[YYY_sp_Facebook_v2_Update_When_Send_Message]", CommandType.StoredProcedure
        //             , "@message", SqlDbType.NVarChar, message
        //             , "@page", SqlDbType.NVarChar, page
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            ds = await confunc.ExecuteDataSet("[YYY_sp_Facebook_v2_Load_History_Comment]", CommandType.StoredProcedure
        //             , "@page", SqlDbType.NVarChar, page
        //             , "@client", SqlDbType.NVarChar, client);
        //        }
        //        return Content(JsonConvert.SerializeObject(ds));
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            confunc.ExecuteDataSet("[YYY_sp_Facebook_v2_LongToken_Failure]", CommandType.StoredProcedure
