    ...
    public class FacebookPageEmpDetail : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        SerType = await confunc.ExecuteDataTable("MLU_sp_Setting_FB_Fanpage_Emp_LoadComboUE" ,CommandType.StoredProcedure);
        ...
        public async Task<IActionResult> OnPostLoadDetail(int ID)
        {
            ...
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[MLU_sp_Setting_FB_Fanpage_Emp_LoadDetail]" , CommandType.StoredProcedure,
        ...
        public async Task<IActionResult> OnPostExecuted(string data)
        {
            try
            {
                ...
                {
                    await connFunc.ExecuteDataTable("MLU_sp_Setting_FB_Fanpage_Emp_Insert" , CommandType.StoredProcedure                        
