            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dt = await confunc.ExecuteDataTable("MLU_sp_FB_Tag_LoadCombo" ,CommandType.StoredProcedure);
                        dt.TableName = "Tag";
                        return dt;
                    }
                }));
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    {
                        DataTable dt = new DataTable();
                        dt = await confunc.ExecuteDataTable("[MLU_sp_FB_LoadPage]" ,CommandType.StoredProcedure
