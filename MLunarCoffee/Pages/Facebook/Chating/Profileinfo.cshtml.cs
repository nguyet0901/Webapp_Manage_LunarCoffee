    ...
    public class Profileinfo : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSource = await confunc.ExecuteDataTable("YYY_sp_TicketTag_LoadTele" ,CommandType.StoredProcedure ,"@UserID" ,SqlDbType.Int ,user.sys_userid);
        ...
        public async Task<IActionResult> OnPostLoadInfo(string PID ,string PSID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_FB_Info_Load]" ,CommandType.StoredProcedure
        ...
        //        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        //        {
        //            dt = await confunc.ExecuteDataTable("[YYY_sp_FB_Tag_Insert]" ,CommandType.StoredProcedure
        //                ,"@PID" ,SqlDbType.NVarChar ,PID
        //                ,"@PSID" ,SqlDbType.NVarChar ,PSID
        ...
        public async Task<IActionResult> OnPostLoadNote(string PID ,string PSID ,string CurrentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_FB_Content_Load]" ,CommandType.StoredProcedure
                        ,"@PID" ,SqlDbType.NVarChar ,PID
                        ,"@PSID" ,SqlDbType.NVarChar ,PSID
        ...
        public async Task<IActionResult> OnPostExecutedNote(string PID ,string PSID ,string content ,string CurrentID)
        {
            try
            {
                ...
                if (CurrentID == "0")
                {
                    ...
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_FB_Content_Insert]" ,CommandType.StoredProcedure
                            ,"@PID" ,SqlDbType.NVarChar ,PID
                            ,"@PSID" ,SqlDbType.NVarChar ,PSID
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("[YYY_sp_FB_Content_Update]" ,CommandType.StoredProcedure
                            ,"@PID" ,SqlDbType.NVarChar ,PID
                            ,"@PSID" ,SqlDbType.NVarChar ,PSID
                            ,"@Content" ,SqlDbType.NVarChar ,content
                            ,"@UserID" ,SqlDbType.Int ,user.sys_userid
        ...
        public async Task<IActionResult> OnPostDeleteNote(string id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_FB_Content_Delete]" ,CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostExecutedAssign(string PID ,string PSID ,string AssignID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[YYY_sp_FB_FaceCon_Insert]" ,CommandType.StoredProcedure
                        ,"@PID" ,SqlDbType.NVarChar ,PID
                        ,"@PSID" ,SqlDbType.NVarChar ,PSID
