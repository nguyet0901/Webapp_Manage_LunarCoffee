    ...
    public class ServiceDetailModel : PageModel
    {
            ...
            try
            {
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtType = await connFunc.ExecuteDataTable("MLU_sp_v2_ServiceType_LoadCombo" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtUnit = await connFunc.ExecuteDataTable("MLU_sp_Service_UnitCount" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtProUnit = await connFunc.ExecuteDataTable("MLU_sp_Product_Combo_Unit" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtUnitFull = await connFunc.ExecuteDataTable("MLU_sp_Product_Combo_UnitFull" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtMedia = await connFunc.ExecuteDataTable("[MLU_sp_Media_LoadCombo]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtCurrency = await connFunc.ExecuteDataTable("[MLU_sp_Price_Service_Currency]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtBranch = await connFunc.ExecuteDataTable("MLU_sp_Branch_Load" ,CommandType.StoredProcedure
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtSyntaxCode = await connFunc.ExecuteDataTable("[MLU_sp_v2_Service_Get_Syntax_Code]" ,CommandType.StoredProcedure);
                ...
                tasks.Add(Task.Run(async () =>
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        ...
                        dtTreatStage = await connFunc.ExecuteDataTable("[MLU_sp_Service_TreatStage_Combo]" ,CommandType.StoredProcedure);
                ...
                if (currentid != 0)
                {
                    ...
                    {
                        dsdetail = await confunc.ExecuteDataSet("[MLU_sp_v2_ServiceDetail_Load]" ,CommandType.StoredProcedure ,
           ...
           ,string dataNote ,string dataStageService ,string priceService ,string service_syntax_code ,string CurrentID)
        {
            ...
            try
            {
                ...
                if (CurrentID == "0")
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_v2_ServiceDetail_Insert" ,CommandType.StoredProcedure ,
                ...
                else
                {
                    using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                    {
                        dt = await connFunc.ExecuteDataTable("MLU_sp_v2_ServiceDetail_Update" ,CommandType.StoredProcedure ,
        ...
        public async Task<IActionResult> OnPostDeleteItem(int id)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                {
                    dt = await connFunc.ExecuteDataTable("[MLU_sp_Service_Delete]" ,CommandType.StoredProcedure ,
