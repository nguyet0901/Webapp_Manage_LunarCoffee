    ...
    public class ServiceComboModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoaddataComboType()
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_ServiceCombo_ComboTypeList]" ,CommandType.StoredProcedure   
                         );
                }
                if (dt != null)
                {
        ...
        public async Task<IActionResult> OnPostLoaddataServiceCombo(string TypeID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_Service_Combo_LoadList]" ,CommandType.StoredProcedure ,
