    ...
    public class UserLogModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostLoadCombo()
        {
            try
            {
                ...
                {
                    dt = await confunc.ExecuteDataTable("YYY_sp_UserLog_LoadType", CommandType.StoredProcedure);
                    dt.TableName = "Type";
                    ds.Tables.Add(dt);
                }
        ...
        public async Task<IActionResult> OnPostLoadDataMaster(string data)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_User_Log_LoadList]" , CommandType.StoredProcedure
        ...
        public async Task<IActionResult> OnPostLoadDataDetail(string data, string currentID)
        {
            try
            {
                ...
                using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
                {
                    dt = await confunc.ExecuteDataTable("[YYY_sp_User_Log_Loaddetail_V2]", CommandType.StoredProcedure
