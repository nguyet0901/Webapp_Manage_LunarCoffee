                ...
                if (result != "0") {
                    ...
                    if (data != undefined && data.length != 0) {
                        _datapri = data.filter(word =>
                            ...
                            || MS_SearchText(word["City"]).includes(_search_text)
                            || MS_SearchText(word["District"]).includes(_search_text)
                            || MS_SearchText(word["Commune"]).includes(_search_text)
                    ...
                    if (_isresult == 1) {
                        ...
                        sys_Hightlight(_search_text, "search_text_address");
                        ...
                        sys_Hightlight(xoa_dau(_textsign), "search_text_address");
