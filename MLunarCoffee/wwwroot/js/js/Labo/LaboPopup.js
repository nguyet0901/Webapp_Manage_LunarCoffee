function LaboDetail_ChangeStatus(e, currrentid ) {
    let Labo_CurrentID = (currrentid != undefined ? currrentid : 0);
    ...
    Master_Div.append($("#DetailModalLaboChangeStatus"));
    $("#DetailModalLaboChangeStatus").empty();
    $("#DetailModalLaboChangeStatus").css({
        "position": "absolute",
        "top": Popup_Top - 20,
        "left": Popup_Left,
        "display": "block",
    ...
    $("#DetailModalLaboChangeStatus").load("/Labo/Status/LaboChangeStatus?CurrentID=" + Labo_CurrentID + "&ver=" + versionofWebApplication);
}


$(document).mouseup(function (e) {
    let todo_pop_changestatus = $('#DetailModalLaboChangeStatus');
