function AllLog_ThienKhue1() {
    var data = [];
    //page = page - 1;
    //var outbound = [];
    //var inbound = [];
    //if (extension != "") {
    //    outbound = LogCall_ThienKhue(APIbaseurl, Api_Key, DomainAPI, dateFrom, dateTo, 'outbound', extension, page);
    //    inbound = LogCall_ThienKhue(APIbaseurl, Api_Key, DomainAPI, dateFrom, dateTo, 'inbound', extension, page);
    //}
