...
function AllLog_Incall(dateFrom, dateTo, extension) {

    var data = [];
    var allbound = LogCall_Incall(dateFrom, dateTo, extension);
...
function LogCall_Incall(dateFrom, dateTo, extension) {
    let dtResult;
