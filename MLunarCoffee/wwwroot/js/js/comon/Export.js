            ...
            try {
                if (dataExp && dataExp.length > 0) {
                    ...
                    if (merge && Object.entries(merge).length > 0 && merge?.KeyDetail != undefined && merge?.KeyDetail != "") {
                        ...
                        dataExp = exportJsonToExcel_MergesData(dataExp, merge?.KeyDetail);
                    }
                                ...
                                for ([key1, value1] of Object.entries(dataKeyExport)) {
                                    if (typeof value1 === 'object') {
                                        if (exportJsonToExcel_CheckPer(value1[2])) {
                                            e[decodeHtml(value1[0])] = (typeof value1[1] !== 'function' ? value[key1] : value1[1](value[key1], value, value?.IndexRow || index));
                                        }
...
function exportJsonToExcel_MergesData(data, keyDetail) {
    try {
        const mergedData = [];
