...
function AddCell_Price_MinNumber(randomNumber, number) {
    let resulf = '<input class="price_min form-control" id="price_min_' + randomNumber + '"  value="' + number + '" />';
    resulf = resulf;
    return resulf;
}
function AddCell_Price_MaxNumber(randomNumber, number) {
    let resulf = '<input class="price_max form-control" id="price_max_' + randomNumber + '"  value="' + number + '" />';
    resulf = resulf;
    return resulf;
}
