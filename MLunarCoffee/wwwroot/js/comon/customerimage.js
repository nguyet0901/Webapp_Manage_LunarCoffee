      ...
      if (data && data.length > 0) {
         for (var i = 0; i < data.length; i++) {
            ...
            let tr = '<div class="tree-item">'
               ...
               + '<a class="image_edit_folder button_ellipsis_item" data_name="' + item.FolderName + '" data_id="' + item.ID + '"><i class="button_ellipsis_item vtt-icon vttech-icon-edit"></i></a>'
               + '<a class="image_delete_folder button_ellipsis_item" data_name="' + item.FolderName + '" data_id="' + item.ID + '"><i class="button_ellipsis_item vtt-icon vttech-icon-delete"></i></a>'
               + '</div>'
               + '<a id="folder_image_' + item.ID + '" data_id="' + item.ID + '" data-foldername="' + item.FolderName + '" class="item"><i class="vtt-icon vttech-icon-folder_40"></i> <span>'
