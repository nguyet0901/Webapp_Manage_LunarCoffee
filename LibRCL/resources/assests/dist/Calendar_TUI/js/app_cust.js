...
(function (window, Calendar) {
    ...
    cal = new Calendar('#calendar', {
        ...
        template: {
            ...
            //},
            time: function (schedule) {
                return '<span class="headerGridCalendar" style="background-color:'
                    + schedule.bgColor
                    + ';color:'
                    + schedule.color
                    + '">'
                    + schedule.raw.memo
                     + '<span class="headrGridCanlendar_title">' + schedule.title+'</span>'
                    + '</span>'
            ...
            monthGridHeader: function (dayModel) {
                ...
                return '<span style="font-size: 12px;font-weight: 300;" class="' + classNames.join(' ') + '">' + date + '</span>';
            },
        },
        month: {
            //moreLayerSize: {
