		...
		createDateTimePicker = function (input) {
			...
			XDSoft_datetime = function () {
				...
				_this.prevMonth = function () {
					...
					let dateCurrent = (new Date(_this.currentTime)).getTime();
					let dateMin = (new Date(options.minDateTime)).setDate(1);
					if (dateCurrent >= dateMin) {
						...
						_this.currentTime.setMonth(_this.currentTime.getMonth() + 1);
                    }
					return month;
				};
