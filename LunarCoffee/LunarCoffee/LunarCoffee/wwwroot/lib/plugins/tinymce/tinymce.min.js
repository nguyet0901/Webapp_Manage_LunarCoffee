...
! function (e, t) {
    ...
    var s = {},
        ...
        Le = "tinymce/NotificationManager",
        Me = "tinymce/dom/NodePath",
    ...
    r(l, [], function () {
        ...
        var C, x, w, E, N, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F = "sizzle" + -new Date,
            z = window.document,
            W = 0,
            V = 0,
            U = n(),
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this,
                    c, u = 0,
                    d, f, h = [],
                    p, m, g, v, y, b, C, x, w, E, N, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F = 0,
                    z = t.decode,
        ...
        return function (i, a) {
            ...
            function l(t) {
                ...
                n = t.screenX - B, r = t.screenY - D, F = n * R[2] + P, z = r * R[3] + H, F = 5 > F ? 5 : F, z = 5 > z ? 5 : z, i = "IMG" == _.nodeName && a.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == _.nodeName && R[2] * R[3] !== 0, i && ($(n) > $(r) ? (z = q(F * O), F = q(z / O)) : (F = q(z / O), z = q(F * O))), E.setStyles(S, {
                    ...
                    top: s,
                    display: "block"
                }), k.innerHTML = F + " × " + z, R[2] < 0 && S.clientWidth <= F && E.setStyle(S, "left", L + (P - F)), R[3] < 0 && S.clientHeight <= z && E.setStyle(S, "top", M + (H - z)), n = j.scrollWidth - Y, r = j.scrollHeight - X, n + r !== 0 && E.setStyles(k, {
                    left: o - n,
                    top: s - r
            ...
            function u(e, t, n) {
                var i, o, u, f, h;
                d(), b(), i = E.getPos(e, j), L = i.x, M = i.y, h = e.getBoundingClientRect(), o = h.width || h.right - h.left, u = h.height || h.bottom - h.top, _ != e && (y(), _ = e, F = z = 0), f = a.fire("ObjectSelected", {
                    target: e
            ...
            var E = a.dom,
                N = t.each,
                _, S, k, T, R, A, B, D, L, M, P, H, O, I, F, z, W = a.getDoc(),
                V = document,
                U = r.ie && r.ie < 11,
                $ = Math.abs,
                q = Math.round,
        ...
        return c.prototype = {
            ...
            getRng: function (e) {
                ...
                return (i != undefined) ? (i || (i = (a != undefined && a.createRange) ? a.createRange() : ((a != undefined && a.body != undefined) ? null : ((a != undefined && a.body != undefined) ? a.body.createTextRange() : null)))

                    , i.setStart && 9 === i.startContainer.nodeType &&
                    i.collapsed && (o = n.dom.getRoot(), i.setStart(o, 0), i.setEnd(o, 0)), n.selectedRange &&
                    n.explicitRange &&
                    (0 === t(i.START_TO_START, i, n.selectedRange) &&
                        0 === t(i.END_TO_END, i, n.selectedRange) ? i = n.explicitRange : (n.selectedRange = null, n.explicitRange = null)), i) : null
            ...
            getNode: function () {
                ...
                var t = this,
                    n = t.getRng(),
                    r, i = (n != undefined) ? n.startContainer : null,
                    o = (n != undefined) ? n.endContainer : null,
                    a = (n != undefined) ? n.startOffset : null,
                    s = (n != undefined) ? n.endOffset : null,
                    l = (t != undefined && t.dom != undefined) ? t.dom.getRoot : null ;
            ...
            function o(o) {
                ...
                if (R = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(R), D = R.startContainer, L = R.startOffset, V = (l.force_p_newlines ? "p" : "") || l.forced_root_block, V = V ? V.toUpperCase() : "", P = a.doc.documentMode, H = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (U = L > D.childNodes.length - 1, D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D, L = U && 3 == D.nodeType ? D.nodeValue.length : 0), B = S(D)) {
                        ...
                        V && M === i.getBody() || (V = V || "P", x() ? T() : x(!0) ? (O = M.parentNode.insertBefore(C(), M), m(O), v(M)) : (A = R.cloneRange(), A.setEndAfter(M), I = A.extractContents(), _(I), O = I.firstChild, a.insertAfter(I, M), g(O), k(M), a.isEmpty(M) && b(M), O.normalize(), a.isEmpty(O) ? (a.remove(O), T()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {
                            newBlock: O
                        }), c.add())
                    }
                }
        ...
        return function (r) {
            ...
            r.on("PreInit", function () {
                ...
                mceInsertContent: function (t, n, o) {
                    ...
                    function d(e) {
                        if (T)
                            for (_ = e.firstChild; _; _ = _.walk(!0)) A[_.name] && _.attr("data-mce-new", "true")
                    }
                    ...
                    if (x = g.parse(o, P), d(x), _ = x.lastChild, "mce_marker" == _.attr("id"))
                        for (E = _, _ = _.prev; _; _ = _.walk(!0))
                            if (3 == _.type || !L.isBlock(_.name)) {
                ...
                mceReplaceContent: function (e, t, n) {
                    r.execCommand("mceInsertContent", !1, n.replace(/\{\$selection\}/g, M.getContent({
                        format: "text"
                    })))
                },
                mceInsertLink: function (e, t, n) {
                    ...
                    "string" == typeof n && (n = {
                        href: n
                    }), r = L.getParent(M.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || P.remove("link"), n.href && P.apply("link", n, r)
                },
                selectAll: function () {
                    var e = L.getRoot(),
                        t;
                ...
                InsertLineBreak: function (e, t, n) {
                    function i() {
                        for (var e = new a(h, m), t, n = r.schema.getNonEmptyElements(); t = e.next();)
                ...
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7),
                        n = M.isCollapsed() ? [L.getParent(M.getNode(), L.isBlock)] : M.getSelectedBlocks(),
                        r = f(n, function (e) {
            ...
            h = e.extend({
                ...
                init: function (e) {
                    ...
                    n._super(e), n.isRtl() && n.classes.add("rtl"), n.classes.add("window"), n.bodyClasses.add("window-body"), n.state.set("fixed", !0), e.buttons && (n.statusbar = new t({
                        ...
                        var t = n.classPrefix + "close"; - 1 == e.target.className.indexOf(t) && -1 == e.target.parentNode.className.indexOf(t) || n.close()
        ...
        function y(c) {
            ...
            function A(e) {
                var t;
                return ne.hide(), t = c.fire("BeforeObjectSelected", {
                    target: e
            ...
            function j() {
                ...
                c.on("mouseup", function () {
                    ...
                    var n;
                    if (n = t(e.target)) x(n) ? (e.preventDefault(), K(A(n))) : (G(), r(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY));
                    else {
                        G(), ne.hide();
            ...
            function K(t) {
                ...
                return s = t.startContainer, l = t.startOffset, u = t.endOffset, 3 == s.nodeType && 0 == l && x(s.parentNode) && (s = s.parentNode, l = i.nodeIndex(s), s = s.parentNode), 1 != s.nodeType ? (G(), null) : (u == l + 1 && (n = s.childNodes[l]), x(n) ? (h = p = n.cloneNode(!0), d = c.fire("ObjectSelected", {
                    ...
                    t.setStart(o[0].firstChild, 1), t.setEnd(o[0].lastChild, 0)), o.css({
                        top: i.getPos(n, c.getBody()).y
                    }), c.getBody().focus(), o[0].focus(), a = c.selection.getSel(), a.removeAllRanges(), a.addRange(t), c.$("*[data-mce-selected]").removeAttr("data-mce-selected"), n.setAttribute("data-mce-selected", 1), ie = n, t)) : (G(), null))
            }
            ...
            var Q = c.getBody(),
                ...
                ee = b(v, Z.next),
                te = b(v, Z.prev),
                ne = new o(c.getBody(), y),
                re = "sel-" + c.dom.uniqueId(),
                ie, oe = c.$;
            return e.ceFalse && (j(), Y()), {
        ...
        var b = f.curry,
            ...
            N = i.isBeforeContentEditableFalse,
            _ = c.getSelectedNode;
        return y
        ...
        function A(e, t, i) {
            ...
            a = o.documentBaseUrl = i.documentBaseURL, s = i.baseURI, l = i.defaultSettings, t = M({
                ...
                ie7_compat: !0
            }, l, t), l && l.external_plugins && t.external_plugins && (t.external_plugins = M({}, l.external_plugins, t.external_plugins)), o.settings = t, r.language = t.language || "en", r.languageLoad = t.language_load, r.baseURL = i.baseURL, o.id = t.id = e, o.setDirty(!1), o.plugins = {}, o.documentBaseURI = new p(t.document_base_url || a, {
                base_uri: s
        ...
        return A.prototype = {
            ...
            initContentBody: function (t) {
                ...
                r.inline || (n.getElement().style.visibility = n.orgVisibility), t || r.content_editable || (h.open()
                    /*, h.write(n.iframeHTML)*/
                    , h.close()), r.content_editable && (n.on("remove", function () {
                        var e = this.getBody();
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [],
                    y, b, C, x, w, E, N, _, S, k, T, R, A, B, D, L, M, P, H, O, I, F, z = Math.max,
                    W = Math.min;
